...
public class CreateVertexImpl extends VertexImpl implements de.uni_koblenz.jgralab.gretl.template.CreateVertex, de.uni_koblenz.jgralab.Vertex {
	...
	public CreateVertexImpl(int id, de.uni_koblenz.jgralab.Graph g) {
		super(id, g);
	}

	@Override
	public final de.uni_koblenz.jgralab.schema.VertexClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.gretl.template.CreateVertex.VC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Vertex> getSchemaClass() {
		return de.uni_koblenz.jgralab.gretl.template.CreateVertex.class;
	}
	...
	public <T> T getAttribute(String attributeName) {
		...
		throw new NoSuchAttributeException("CreateVertex doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.gretl.template.CreateVertex getNextCreateVertex() {
		return (de.uni_koblenz.jgralab.gretl.template.CreateVertex)getNextVertex(de.uni_koblenz.jgralab.gretl.template.CreateVertex.class);
	}

	@Override
	public de.uni_koblenz.jgralab.gretl.template.CreateEdge getFirstCreateEdgeIncidence() {
		return (de.uni_koblenz.jgralab.gretl.template.CreateEdge)getFirstIncidence(de.uni_koblenz.jgralab.gretl.template.CreateEdge.class);
	}

	@Override
	public de.uni_koblenz.jgralab.gretl.template.CreateEdge getFirstCreateEdgeIncidence(EdgeDirection orientation) {
		return (de.uni_koblenz.jgralab.gretl.template.CreateEdge)getFirstIncidence(de.uni_koblenz.jgralab.gretl.template.CreateEdge.class, orientation);
	}
		@Override
		public de.uni_koblenz.jgralab.gretl.template.CreateEdge add_src(de.uni_koblenz.jgralab.gretl.template.CreateVertex vertex) {
			return ((de.uni_koblenz.jgralab.gretl.template.TemplateGraph)getGraph()).createEdge(de.uni_koblenz.jgralab.gretl.template.CreateEdge.EC, (de.uni_koblenz.jgralab.gretl.template.CreateVertex) vertex, (de.uni_koblenz.jgralab.gretl.template.CreateVertex) this);
		}
		@Override
		public java.util.List<? extends de.uni_koblenz.jgralab.gretl.template.CreateVertex> remove_src() {
			java.util.List<de.uni_koblenz.jgralab.gretl.template.CreateVertex> adjacences = new java.util.ArrayList<de.uni_koblenz.jgralab.gretl.template.CreateVertex>();
			de.uni_koblenz.jgralab.gretl.template.CreateEdge edge = (de.uni_koblenz.jgralab.gretl.template.CreateEdge) getFirstIncidence(de.uni_koblenz.jgralab.gretl.template.CreateEdge.class, EdgeDirection.IN);
			while (edge != null) {
				de.uni_koblenz.jgralab.gretl.template.CreateEdge next = (de.uni_koblenz.jgralab.gretl.template.CreateEdge) edge.getNextIncidence(de.uni_koblenz.jgralab.gretl.template.CreateEdge.class, EdgeDirection.IN);
				adjacences.add((de.uni_koblenz.jgralab.gretl.template.CreateVertex) edge.getThat());
				edge.delete();
				edge = next;
			}
			return adjacences;
		...
		public Iterable<? extends de.uni_koblenz.jgralab.gretl.template.CreateVertex> get_src() {
			return new de.uni_koblenz.jgralab.impl.NeighbourIterable<de.uni_koblenz.jgralab.gretl.template.CreateEdge, de.uni_koblenz.jgralab.gretl.template.CreateVertex>(this, de.uni_koblenz.jgralab.gretl.template.CreateEdge.class, EdgeDirection.IN);
		}
		@Override
		public de.uni_koblenz.jgralab.gretl.template.CreateEdge add_dst(de.uni_koblenz.jgralab.gretl.template.CreateVertex vertex) {
			return ((de.uni_koblenz.jgralab.gretl.template.TemplateGraph)getGraph()).createEdge(de.uni_koblenz.jgralab.gretl.template.CreateEdge.EC, (de.uni_koblenz.jgralab.gretl.template.CreateVertex) this, (de.uni_koblenz.jgralab.gretl.template.CreateVertex) vertex);
		}
		@Override
		public java.util.List<? extends de.uni_koblenz.jgralab.gretl.template.CreateVertex> remove_dst() {
			java.util.List<de.uni_koblenz.jgralab.gretl.template.CreateVertex> adjacences = new java.util.ArrayList<de.uni_koblenz.jgralab.gretl.template.CreateVertex>();
			de.uni_koblenz.jgralab.gretl.template.CreateEdge edge = (de.uni_koblenz.jgralab.gretl.template.CreateEdge) getFirstIncidence(de.uni_koblenz.jgralab.gretl.template.CreateEdge.class, EdgeDirection.OUT);
			while (edge != null) {
				de.uni_koblenz.jgralab.gretl.template.CreateEdge next = (de.uni_koblenz.jgralab.gretl.template.CreateEdge) edge.getNextIncidence(de.uni_koblenz.jgralab.gretl.template.CreateEdge.class, EdgeDirection.OUT);
				adjacences.add((de.uni_koblenz.jgralab.gretl.template.CreateVertex) edge.getThat());
				edge.delete();
				edge = next;
			}
		...
		public Iterable<? extends de.uni_koblenz.jgralab.gretl.template.CreateVertex> get_dst() {
			return new de.uni_koblenz.jgralab.impl.NeighbourIterable<de.uni_koblenz.jgralab.gretl.template.CreateEdge, de.uni_koblenz.jgralab.gretl.template.CreateVertex>(this, de.uni_koblenz.jgralab.gretl.template.CreateEdge.class, EdgeDirection.OUT);
		}

	@Override
	public Iterable<de.uni_koblenz.jgralab.gretl.template.CreateEdge> getCreateEdgeIncidences() {
		return new IncidenceIterable<de.uni_koblenz.jgralab.gretl.template.CreateEdge>(this, de.uni_koblenz.jgralab.gretl.template.CreateEdge.class);
	}
	
	@Override
	public Iterable<de.uni_koblenz.jgralab.gretl.template.CreateEdge> getCreateEdgeIncidences(EdgeDirection direction) {
		return new IncidenceIterable<de.uni_koblenz.jgralab.gretl.template.CreateEdge>(this, de.uni_koblenz.jgralab.gretl.template.CreateEdge.class, direction);
	}
}
