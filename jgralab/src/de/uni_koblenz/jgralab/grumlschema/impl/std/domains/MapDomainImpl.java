...
public class MapDomainImpl extends VertexImpl implements de.uni_koblenz.jgralab.grumlschema.domains.Domain, de.uni_koblenz.jgralab.grumlschema.domains.MapDomain {

	protected java.lang.String _qualifiedName;

	public MapDomainImpl(int id, de.uni_koblenz.jgralab.Graph g) {
		super(id, g);
	}

	@Override
	public final de.uni_koblenz.jgralab.schema.VertexClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.grumlschema.domains.MapDomain.VC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Vertex> getSchemaClass() {
		return de.uni_koblenz.jgralab.grumlschema.domains.MapDomain.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("qualifiedName")) return (T) get_qualifiedName();
		throw new NoSuchAttributeException("domains.MapDomain doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.grumlschema.domains.MapDomain getNextMapDomain() {
		return (de.uni_koblenz.jgralab.grumlschema.domains.MapDomain)getNextVertex(de.uni_koblenz.jgralab.grumlschema.domains.MapDomain.class);
	}
	...
	public de.uni_koblenz.jgralab.grumlschema.structure.HasDomain getFirstHasDomainIncidence(EdgeDirection orientation) {
		...
		public de.uni_koblenz.jgralab.grumlschema.structure.Annotates add_comment(de.uni_koblenz.jgralab.grumlschema.structure.Comment vertex) {
			return ((de.uni_koblenz.jgralab.grumlschema.SchemaGraph)getGraph()).createEdge(de.uni_koblenz.jgralab.grumlschema.structure.Annotates.EC, (de.uni_koblenz.jgralab.grumlschema.structure.Comment) vertex, (de.uni_koblenz.jgralab.grumlschema.domains.MapDomain) this);
		}
		@Override
		...
		public de.uni_koblenz.jgralab.grumlschema.domains.HasKeyDomain add_keydomain(de.uni_koblenz.jgralab.grumlschema.domains.Domain vertex) {
			return ((de.uni_koblenz.jgralab.grumlschema.SchemaGraph)getGraph()).createEdge(de.uni_koblenz.jgralab.grumlschema.domains.HasKeyDomain.EC, (de.uni_koblenz.jgralab.grumlschema.domains.MapDomain) this, (de.uni_koblenz.jgralab.grumlschema.domains.Domain) vertex);
		}
		@Override
		public java.util.List<? extends de.uni_koblenz.jgralab.grumlschema.domains.Domain> remove_keydomain() {
			...
			de.uni_koblenz.jgralab.grumlschema.domains.HasKeyDomain edge = (de.uni_koblenz.jgralab.grumlschema.domains.HasKeyDomain) getFirstIncidence(de.uni_koblenz.jgralab.grumlschema.domains.HasKeyDomain.class, EdgeDirection.OUT);
			while (edge != null) {
				de.uni_koblenz.jgralab.grumlschema.domains.HasKeyDomain next = (de.uni_koblenz.jgralab.grumlschema.domains.HasKeyDomain) edge.getNextIncidence(de.uni_koblenz.jgralab.grumlschema.domains.HasKeyDomain.class, EdgeDirection.OUT);
		...
		public de.uni_koblenz.jgralab.grumlschema.domains.HasValueDomain add_valuedomain(de.uni_koblenz.jgralab.grumlschema.domains.Domain vertex) {
			return ((de.uni_koblenz.jgralab.grumlschema.SchemaGraph)getGraph()).createEdge(de.uni_koblenz.jgralab.grumlschema.domains.HasValueDomain.EC, (de.uni_koblenz.jgralab.grumlschema.domains.MapDomain) this, (de.uni_koblenz.jgralab.grumlschema.domains.Domain) vertex);
		}
		@Override
		public java.util.List<? extends de.uni_koblenz.jgralab.grumlschema.domains.Domain> remove_valuedomain() {
			java.util.List<de.uni_koblenz.jgralab.grumlschema.domains.Domain> adjacences = new java.util.ArrayList<de.uni_koblenz.jgralab.grumlschema.domains.Domain>();
			de.uni_koblenz.jgralab.grumlschema.domains.HasValueDomain edge = (de.uni_koblenz.jgralab.grumlschema.domains.HasValueDomain) getFirstIncidence(de.uni_koblenz.jgralab.grumlschema.domains.HasValueDomain.class, EdgeDirection.OUT);
			while (edge != null) {
				de.uni_koblenz.jgralab.grumlschema.domains.HasValueDomain next = (de.uni_koblenz.jgralab.grumlschema.domains.HasValueDomain) edge.getNextIncidence(de.uni_koblenz.jgralab.grumlschema.domains.HasValueDomain.class, EdgeDirection.OUT);
				adjacences.add((de.uni_koblenz.jgralab.grumlschema.domains.Domain) edge.getThat());
				edge.delete();
				edge = next;
			}
