...
public class RecordDomainImpl extends VertexImpl implements de.uni_koblenz.jgralab.grumlschema.domains.Domain, de.uni_koblenz.jgralab.grumlschema.domains.RecordDomain {

	protected java.lang.String _qualifiedName;

	public RecordDomainImpl(int id, de.uni_koblenz.jgralab.Graph g) {
		super(id, g);
	}

	@Override
	public final de.uni_koblenz.jgralab.schema.VertexClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.grumlschema.domains.RecordDomain.VC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Vertex> getSchemaClass() {
		return de.uni_koblenz.jgralab.grumlschema.domains.RecordDomain.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("qualifiedName")) return (T) get_qualifiedName();
		throw new NoSuchAttributeException("domains.RecordDomain doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.grumlschema.domains.RecordDomain getNextRecordDomain() {
		return (de.uni_koblenz.jgralab.grumlschema.domains.RecordDomain)getNextVertex(de.uni_koblenz.jgralab.grumlschema.domains.RecordDomain.class);
	}
	...
	public de.uni_koblenz.jgralab.grumlschema.structure.HasDomain getFirstHasDomainIncidence(EdgeDirection orientation) {
		...
		public de.uni_koblenz.jgralab.grumlschema.structure.Annotates add_comment(de.uni_koblenz.jgralab.grumlschema.structure.Comment vertex) {
			return ((de.uni_koblenz.jgralab.grumlschema.SchemaGraph)getGraph()).createEdge(de.uni_koblenz.jgralab.grumlschema.structure.Annotates.EC, (de.uni_koblenz.jgralab.grumlschema.structure.Comment) vertex, (de.uni_koblenz.jgralab.grumlschema.domains.RecordDomain) this);
		}
		@Override
		...
		public de.uni_koblenz.jgralab.grumlschema.domains.HasRecordDomainComponent add_componentdomain(de.uni_koblenz.jgralab.grumlschema.domains.Domain vertex) {
			return ((de.uni_koblenz.jgralab.grumlschema.SchemaGraph)getGraph()).createEdge(de.uni_koblenz.jgralab.grumlschema.domains.HasRecordDomainComponent.EC, (de.uni_koblenz.jgralab.grumlschema.domains.RecordDomain) this, (de.uni_koblenz.jgralab.grumlschema.domains.Domain) vertex);
		}
		@Override
		public java.util.List<? extends de.uni_koblenz.jgralab.grumlschema.domains.Domain> remove_componentdomain() {
			...
			de.uni_koblenz.jgralab.grumlschema.domains.HasRecordDomainComponent edge = (de.uni_koblenz.jgralab.grumlschema.domains.HasRecordDomainComponent) getFirstIncidence(de.uni_koblenz.jgralab.grumlschema.domains.HasRecordDomainComponent.class, EdgeDirection.OUT);
			while (edge != null) {
				de.uni_koblenz.jgralab.grumlschema.domains.HasRecordDomainComponent next = (de.uni_koblenz.jgralab.grumlschema.domains.HasRecordDomainComponent) edge.getNextIncidence(de.uni_koblenz.jgralab.grumlschema.domains.HasRecordDomainComponent.class, EdgeDirection.OUT);
		...
		public Iterable<? extends de.uni_koblenz.jgralab.grumlschema.domains.Domain> get_componentdomain() {
			return new de.uni_koblenz.jgralab.impl.NeighbourIterable<de.uni_koblenz.jgralab.grumlschema.domains.HasRecordDomainComponent, de.uni_koblenz.jgralab.grumlschema.domains.Domain>(this, de.uni_koblenz.jgralab.grumlschema.domains.HasRecordDomainComponent.class, EdgeDirection.OUT);
		}
