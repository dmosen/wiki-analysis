...
public class SetDomainImpl extends VertexImpl implements de.uni_koblenz.jgralab.grumlschema.domains.CollectionDomain, de.uni_koblenz.jgralab.grumlschema.domains.SetDomain {

	protected java.lang.String _qualifiedName;

	public SetDomainImpl(int id, de.uni_koblenz.jgralab.Graph g) {
		super(id, g);
	}

	@Override
	public final de.uni_koblenz.jgralab.schema.VertexClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.grumlschema.domains.SetDomain.VC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Vertex> getSchemaClass() {
		return de.uni_koblenz.jgralab.grumlschema.domains.SetDomain.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("qualifiedName")) return (T) get_qualifiedName();
		throw new NoSuchAttributeException("domains.SetDomain doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.grumlschema.domains.CollectionDomain getNextCollectionDomain() {
		return (de.uni_koblenz.jgralab.grumlschema.domains.CollectionDomain)getNextVertex(de.uni_koblenz.jgralab.grumlschema.domains.CollectionDomain.class);
	}
	...
	@Override
	public de.uni_koblenz.jgralab.grumlschema.domains.SetDomain getNextSetDomain() {
		return (de.uni_koblenz.jgralab.grumlschema.domains.SetDomain)getNextVertex(de.uni_koblenz.jgralab.grumlschema.domains.SetDomain.class);
	}
	...
	public de.uni_koblenz.jgralab.grumlschema.structure.HasDomain getFirstHasDomainIncidence(EdgeDirection orientation) {
		...
		public de.uni_koblenz.jgralab.grumlschema.structure.Annotates add_comment(de.uni_koblenz.jgralab.grumlschema.structure.Comment vertex) {
			return ((de.uni_koblenz.jgralab.grumlschema.SchemaGraph)getGraph()).createEdge(de.uni_koblenz.jgralab.grumlschema.structure.Annotates.EC, (de.uni_koblenz.jgralab.grumlschema.structure.Comment) vertex, (de.uni_koblenz.jgralab.grumlschema.domains.SetDomain) this);
		}
		@Override
		...
		public de.uni_koblenz.jgralab.grumlschema.domains.HasBaseDomain add_basedomain(de.uni_koblenz.jgralab.grumlschema.domains.Domain vertex) {
			return ((de.uni_koblenz.jgralab.grumlschema.SchemaGraph)getGraph()).createEdge(de.uni_koblenz.jgralab.grumlschema.domains.HasBaseDomain.EC, (de.uni_koblenz.jgralab.grumlschema.domains.SetDomain) this, (de.uni_koblenz.jgralab.grumlschema.domains.Domain) vertex);
		}
		@Override
		public java.util.List<? extends de.uni_koblenz.jgralab.grumlschema.domains.Domain> remove_basedomain() {
			...
			de.uni_koblenz.jgralab.grumlschema.domains.HasBaseDomain edge = (de.uni_koblenz.jgralab.grumlschema.domains.HasBaseDomain) getFirstIncidence(de.uni_koblenz.jgralab.grumlschema.domains.HasBaseDomain.class, EdgeDirection.OUT);
			while (edge != null) {
				de.uni_koblenz.jgralab.grumlschema.domains.HasBaseDomain next = (de.uni_koblenz.jgralab.grumlschema.domains.HasBaseDomain) edge.getNextIncidence(de.uni_koblenz.jgralab.grumlschema.domains.HasBaseDomain.class, EdgeDirection.OUT);
