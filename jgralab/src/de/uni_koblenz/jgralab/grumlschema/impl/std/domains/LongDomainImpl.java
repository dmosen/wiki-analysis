...
public class LongDomainImpl extends VertexImpl implements de.uni_koblenz.jgralab.grumlschema.domains.BasicDomain, de.uni_koblenz.jgralab.grumlschema.domains.LongDomain {

	protected java.lang.String _qualifiedName;

	public LongDomainImpl(int id, de.uni_koblenz.jgralab.Graph g) {
		super(id, g);
	}

	@Override
	public final de.uni_koblenz.jgralab.schema.VertexClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.grumlschema.domains.LongDomain.VC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Vertex> getSchemaClass() {
		return de.uni_koblenz.jgralab.grumlschema.domains.LongDomain.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("qualifiedName")) return (T) get_qualifiedName();
		throw new NoSuchAttributeException("domains.LongDomain doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.grumlschema.domains.LongDomain getNextLongDomain() {
		return (de.uni_koblenz.jgralab.grumlschema.domains.LongDomain)getNextVertex(de.uni_koblenz.jgralab.grumlschema.domains.LongDomain.class);
	}
	...
	public de.uni_koblenz.jgralab.grumlschema.structure.HasDomain getFirstHasDomainIncidence(EdgeDirection orientation) {
		...
		public de.uni_koblenz.jgralab.grumlschema.structure.Annotates add_comment(de.uni_koblenz.jgralab.grumlschema.structure.Comment vertex) {
			return ((de.uni_koblenz.jgralab.grumlschema.SchemaGraph)getGraph()).createEdge(de.uni_koblenz.jgralab.grumlschema.structure.Annotates.EC, (de.uni_koblenz.jgralab.grumlschema.structure.Comment) vertex, (de.uni_koblenz.jgralab.grumlschema.domains.LongDomain) this);
		}
		@Override
