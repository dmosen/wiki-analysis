...
public class ReversedRedefinesImpl extends ReversedEdgeImpl implements de.uni_koblenz.jgralab.grumlschema.structure.Redefines, de.uni_koblenz.jgralab.grumlschema.structure.Subsets {

	ReversedRedefinesImpl(EdgeImpl e, Graph g) {
		super(e, g);
	}
	...
	public de.uni_koblenz.jgralab.grumlschema.structure.Redefines getNextRedefinesInGraph() {
		return ((de.uni_koblenz.jgralab.grumlschema.structure.Redefines)normalEdge).getNextRedefinesInGraph();
	}
