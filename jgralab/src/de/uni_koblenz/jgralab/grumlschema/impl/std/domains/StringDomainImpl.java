...
public class StringDomainImpl extends VertexImpl implements de.uni_koblenz.jgralab.grumlschema.domains.BasicDomain, de.uni_koblenz.jgralab.grumlschema.domains.StringDomain {

	protected java.lang.String _qualifiedName;

	public StringDomainImpl(int id, de.uni_koblenz.jgralab.Graph g) {
		super(id, g);
	}

	@Override
	public final de.uni_koblenz.jgralab.schema.VertexClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.grumlschema.domains.StringDomain.VC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Vertex> getSchemaClass() {
		return de.uni_koblenz.jgralab.grumlschema.domains.StringDomain.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("qualifiedName")) return (T) get_qualifiedName();
		throw new NoSuchAttributeException("domains.StringDomain doesn't contain an attribute " + attributeName);
	}
	...
	@Override
	public de.uni_koblenz.jgralab.grumlschema.domains.StringDomain getNextStringDomain() {
		return (de.uni_koblenz.jgralab.grumlschema.domains.StringDomain)getNextVertex(de.uni_koblenz.jgralab.grumlschema.domains.StringDomain.class);
	}
	...
	public de.uni_koblenz.jgralab.grumlschema.structure.HasDomain getFirstHasDomainIncidence(EdgeDirection orientation) {
		...
		public de.uni_koblenz.jgralab.grumlschema.structure.Annotates add_comment(de.uni_koblenz.jgralab.grumlschema.structure.Comment vertex) {
			return ((de.uni_koblenz.jgralab.grumlschema.SchemaGraph)getGraph()).createEdge(de.uni_koblenz.jgralab.grumlschema.structure.Annotates.EC, (de.uni_koblenz.jgralab.grumlschema.structure.Comment) vertex, (de.uni_koblenz.jgralab.grumlschema.domains.StringDomain) this);
		}
		@Override
