...
public class EnumDomainImpl extends VertexImpl implements de.uni_koblenz.jgralab.grumlschema.domains.Domain, de.uni_koblenz.jgralab.grumlschema.domains.EnumDomain {

	protected org.pcollections.PVector<java.lang.String> _enumConstants;

	protected java.lang.String _qualifiedName;

	public EnumDomainImpl(int id, de.uni_koblenz.jgralab.Graph g) {
		super(id, g);
	}

	@Override
	public final de.uni_koblenz.jgralab.schema.VertexClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.grumlschema.domains.EnumDomain.VC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Vertex> getSchemaClass() {
		return de.uni_koblenz.jgralab.grumlschema.domains.EnumDomain.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("enumConstants")) return (T) get_enumConstants();
		if (attributeName.equals("qualifiedName")) return (T) get_qualifiedName();
		throw new NoSuchAttributeException("domains.EnumDomain doesn't contain an attribute " + attributeName);
	}

	@SuppressWarnings("unchecked")
	public <T> void setAttribute(String attributeName, T data) {
		if (attributeName.equals("enumConstants")) {
			set_enumConstants((org.pcollections.PVector<java.lang.String>) data);
			return;
		}
	...
	public org.pcollections.PVector<java.lang.String> get_enumConstants() {
		return _enumConstants;
	}

	public void set_enumConstants(org.pcollections.PVector<java.lang.String> _enumConstants) {
		ecaAttributeChanging("enumConstants", this._enumConstants, _enumConstants);
		Object oldValue = this._enumConstants;
		this._enumConstants = _enumConstants;
		graphModified();
	ecaAttributeChanged("enumConstants", oldValue, _enumConstants);
	}
	...
	public void readAttributeValues(GraphIO io) throws GraphIOException {
		...
		if (io.isNextToken("[")) {
			org.pcollections.PVector<java.lang.String> $_enumConstants = de.uni_koblenz.jgralab.JGraLab.vector();
			io.match("[");
			while (!io.isNextToken("]")) {
				java.lang.String $_enumConstantsElement;
				$_enumConstantsElement = io.matchUtfString();
				$_enumConstants = $_enumConstants.plus($_enumConstantsElement);
			}
			io.match("]");
			_enumConstants = $_enumConstants;
		...
		set_enumConstants(_enumConstants);
	...
	public void writeAttributeValues(GraphIO io) throws GraphIOException, IOException {
		...
		if (_enumConstants != null) {
			...
			io.write("[");
			io.noSpace();
			for (java.lang.String _enumConstantsElement : _enumConstants) {
				io.writeUtfString(_enumConstantsElement);
			}
			io.write("]");
			io.space();
		} else {
	...
	@Override
	public de.uni_koblenz.jgralab.grumlschema.domains.EnumDomain getNextEnumDomain() {
		return (de.uni_koblenz.jgralab.grumlschema.domains.EnumDomain)getNextVertex(de.uni_koblenz.jgralab.grumlschema.domains.EnumDomain.class);
	}
	...
	public de.uni_koblenz.jgralab.grumlschema.structure.HasDomain getFirstHasDomainIncidence(EdgeDirection orientation) {
		...
		public de.uni_koblenz.jgralab.grumlschema.structure.Annotates add_comment(de.uni_koblenz.jgralab.grumlschema.structure.Comment vertex) {
			return ((de.uni_koblenz.jgralab.grumlschema.SchemaGraph)getGraph()).createEdge(de.uni_koblenz.jgralab.grumlschema.structure.Annotates.EC, (de.uni_koblenz.jgralab.grumlschema.structure.Comment) vertex, (de.uni_koblenz.jgralab.grumlschema.domains.EnumDomain) this);
		}
		@Override
