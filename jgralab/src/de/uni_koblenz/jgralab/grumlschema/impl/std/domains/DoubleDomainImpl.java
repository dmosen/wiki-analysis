...
public class DoubleDomainImpl extends VertexImpl implements de.uni_koblenz.jgralab.grumlschema.domains.BasicDomain, de.uni_koblenz.jgralab.grumlschema.domains.DoubleDomain {

	protected java.lang.String _qualifiedName;

	public DoubleDomainImpl(int id, de.uni_koblenz.jgralab.Graph g) {
		super(id, g);
	}

	@Override
	public final de.uni_koblenz.jgralab.schema.VertexClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.grumlschema.domains.DoubleDomain.VC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Vertex> getSchemaClass() {
		return de.uni_koblenz.jgralab.grumlschema.domains.DoubleDomain.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("qualifiedName")) return (T) get_qualifiedName();
		throw new NoSuchAttributeException("domains.DoubleDomain doesn't contain an attribute " + attributeName);
	}
	...
	@Override
	public de.uni_koblenz.jgralab.grumlschema.domains.DoubleDomain getNextDoubleDomain() {
		return (de.uni_koblenz.jgralab.grumlschema.domains.DoubleDomain)getNextVertex(de.uni_koblenz.jgralab.grumlschema.domains.DoubleDomain.class);
	}
	...
	public de.uni_koblenz.jgralab.grumlschema.structure.HasDomain getFirstHasDomainIncidence(EdgeDirection orientation) {
		...
		public de.uni_koblenz.jgralab.grumlschema.structure.Annotates add_comment(de.uni_koblenz.jgralab.grumlschema.structure.Comment vertex) {
			return ((de.uni_koblenz.jgralab.grumlschema.SchemaGraph)getGraph()).createEdge(de.uni_koblenz.jgralab.grumlschema.structure.Annotates.EC, (de.uni_koblenz.jgralab.grumlschema.structure.Comment) vertex, (de.uni_koblenz.jgralab.grumlschema.domains.DoubleDomain) this);
		}
		@Override
