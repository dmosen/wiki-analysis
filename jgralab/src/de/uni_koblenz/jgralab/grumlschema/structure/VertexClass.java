...
public interface VertexClass extends de.uni_koblenz.jgralab.grumlschema.structure.GraphElementClass {

	public static final de.uni_koblenz.jgralab.schema.VertexClass VC = de.uni_koblenz.jgralab.grumlschema.GrumlSchema.instance().vc_structure_VertexClass;
	...
	/**
	 * @return the next de.uni_koblenz.jgralab.grumlschema.structure.VertexClass vertex in the global vertex sequence
	 */
	...
	/**
	 * @return the first edge of class SpecializesVertexClass at this vertex
	 */
	...
	public de.uni_koblenz.jgralab.grumlschema.structure.SpecializesVertexClass getFirstSpecializesVertexClassIncidence(EdgeDirection orientation);
		 ...
		 * <code>de.uni_koblenz.jgralab.grumlschema.structure.SpecializesVertexClass</code> edge from this vertex to the given 
		 * one and returns the created edge.
		 * @return  a newly created edge of type <code>de.uni_koblenz.jgralab.grumlschema.structure.SpecializesVertexClass</code>
		 ...
		 * deleting the <code>de.uni_koblenz.jgralab.grumlschema.structure.SpecializesVertexClass</code> edges of this vertex to 
		 ...
		 * deletes the <code>de.uni_koblenz.jgralab.grumlschema.structure.SpecializesVertexClass</code> edge connections of this vertex with 
		 * the given one.
		 */
		 ...
		 *         (connected with a <code>de.uni_koblenz.jgralab.grumlschema.structure.SpecializesVertexClass</code> edge).
		 */
		...
		/**
		 * adds the given vertex as <code>incidence</code> to this vertex, i.e. creates an
		...
		/**
		 * removes all incidence adjacences to all vertices by 
		...
		/**
		 * removes the given vertex as <code>incidence</code> from this vertex, i.e. 
		...
		/**
		 * @return an Iterable of all vertices adjacent to this one with the rolename 'incidence'
		 *         (connected with a <code>de.uni_koblenz.jgralab.grumlschema.structure.EndsAt</code> edge).
		 */
	...
	/**
	 * Returns an Iterable for all incidence edges of this vertex that are of type SpecializesVertexClass or subtypes.
	 */
	public Iterable<de.uni_koblenz.jgralab.grumlschema.structure.SpecializesVertexClass> getSpecializesVertexClassIncidences();
	
	/**
	 * Returns an Iterable for all incidence edges of this vertex that are of type SpecializesVertexClass.
	 * @param direction EdgeDirection.IN or EdgeDirection.OUT, only edges of this direction will be included in the Iterable
	 */
