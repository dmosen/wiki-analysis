...
public interface ContainsDefaultPackage extends de.uni_koblenz.jgralab.Edge {

	public static final de.uni_koblenz.jgralab.schema.EdgeClass EC = de.uni_koblenz.jgralab.grumlschema.GrumlSchema.instance().ec_structure_ContainsDefaultPackage;

	/**
	 * @return the next de.uni_koblenz.jgralab.grumlschema.structure.ContainsDefaultPackage edge in the global edge sequence
	 */
	public de.uni_koblenz.jgralab.grumlschema.structure.ContainsDefaultPackage getNextContainsDefaultPackageInGraph();

	/**
	 * @return the next edge of class de.uni_koblenz.jgralab.grumlschema.structure.ContainsDefaultPackage at the "this" vertex
	 */
