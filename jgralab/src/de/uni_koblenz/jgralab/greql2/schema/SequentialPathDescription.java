...
public interface SequentialPathDescription extends de.uni_koblenz.jgralab.greql2.schema.PathDescription {

	public static final de.uni_koblenz.jgralab.schema.VertexClass VC = de.uni_koblenz.jgralab.greql2.schema.Greql2Schema.instance().vc_SequentialPathDescription;
	...
	/**
	 * @return the next de.uni_koblenz.jgralab.greql2.schema.SequentialPathDescription vertex in the global vertex sequence
	 */
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsSequenceElementOf getFirstIsSequenceElementOfIncidence(EdgeDirection orientation);
		...
		/**
		 * adds the given vertex as <code>sequenceElement</code> to this vertex, i.e. creates an
		 * <code>de.uni_koblenz.jgralab.greql2.schema.IsSequenceElementOf</code> edge from this vertex to the given 
		 * one and returns the created edge.
		 * @return  a newly created edge of type <code>de.uni_koblenz.jgralab.greql2.schema.IsSequenceElementOf</code>
		 *          between this vertex and the given one.
		 */
		...
		/**
		 * removes all sequenceElement adjacences to all vertices by 
		 * deleting the <code>de.uni_koblenz.jgralab.greql2.schema.IsSequenceElementOf</code> edges of this vertex to 
		 * all other ones, but doesn't delete those vertices.
		 *
		 * @return the adjacent vertices prior to removal of incidences
		 */
		...
		/**
		 * removes the given vertex as <code>sequenceElement</code> from this vertex, i.e. 
		 * deletes the <code>de.uni_koblenz.jgralab.greql2.schema.IsSequenceElementOf</code> edge connections of this vertex with 
		 * the given one.
		 */
		public boolean remove_sequenceElement(de.uni_koblenz.jgralab.greql2.schema.PathDescription vertex);
		/**
		 * @return an Iterable of all vertices adjacent to this one with the rolename 'sequenceElement'
		 *         (connected with a <code>de.uni_koblenz.jgralab.greql2.schema.IsSequenceElementOf</code> edge).
		 */
