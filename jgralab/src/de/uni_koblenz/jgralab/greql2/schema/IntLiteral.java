...
public interface IntLiteral extends de.uni_koblenz.jgralab.greql2.schema.Literal {

	public static final de.uni_koblenz.jgralab.schema.VertexClass VC = de.uni_koblenz.jgralab.greql2.schema.Greql2Schema.instance().vc_IntLiteral;
	...
	/**
	 * @return the next de.uni_koblenz.jgralab.greql2.schema.IntLiteral vertex in the global vertex sequence
	 */
	public de.uni_koblenz.jgralab.greql2.schema.IntLiteral getNextIntLiteral();

	/**
	 * @return the next de.uni_koblenz.jgralab.greql2.schema.Literal vertex in the global vertex sequence
	 */
