...
public interface EdgeTypeSubgraph extends de.uni_koblenz.jgralab.greql2.schema.SubgraphDefinition {

	public static final de.uni_koblenz.jgralab.schema.VertexClass VC = de.uni_koblenz.jgralab.greql2.schema.Greql2Schema.instance().vc_EdgeTypeSubgraph;

	/**
	 * @return the next de.uni_koblenz.jgralab.greql2.schema.EdgeTypeSubgraph vertex in the global vertex sequence
	 */
