...
import de.uni_koblenz.jgralab.greql2.schema.impl.std.ReversedIsVarOfImpl;
...
public class IsVarOfImpl extends EdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.Greql2Aggregation, de.uni_koblenz.jgralab.greql2.schema.IsVarOf {

	protected org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions;

	public IsVarOfImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsVarOf.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsVarOf.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("sourcePositions")) return (T) get_sourcePositions();
		throw new NoSuchAttributeException("IsVarOf doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsVarOf getNextIsVarOfInGraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsVarOf)getNextEdge(de.uni_koblenz.jgralab.greql2.schema.IsVarOf.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsVarOf getNextIsVarOfIncidence() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsVarOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsVarOf.class);
	}

	public de.uni_koblenz.jgralab.greql2.schema.IsVarOf getNextIsVarOfIncidence(EdgeDirection orientation) {
		return (de.uni_koblenz.jgralab.greql2.schema.IsVarOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsVarOf.class, orientation);
	}
	...
	protected de.uni_koblenz.jgralab.impl.ReversedEdgeBaseImpl createReversedEdge() {
		return new ReversedIsVarOfImpl(this, graph);
	}
