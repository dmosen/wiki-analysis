...
import de.uni_koblenz.jgralab.greql2.schema.impl.std.ReversedIsArgumentOfImpl;
...
public class IsArgumentOfImpl extends EdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.Greql2Aggregation, de.uni_koblenz.jgralab.greql2.schema.IsArgumentOf {

	protected org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions;

	public IsArgumentOfImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsArgumentOf.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsArgumentOf.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("sourcePositions")) return (T) get_sourcePositions();
		throw new NoSuchAttributeException("IsArgumentOf doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsArgumentOf getNextIsArgumentOfInGraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsArgumentOf)getNextEdge(de.uni_koblenz.jgralab.greql2.schema.IsArgumentOf.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsArgumentOf getNextIsArgumentOfIncidence() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsArgumentOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsArgumentOf.class);
	}

	public de.uni_koblenz.jgralab.greql2.schema.IsArgumentOf getNextIsArgumentOfIncidence(EdgeDirection orientation) {
		return (de.uni_koblenz.jgralab.greql2.schema.IsArgumentOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsArgumentOf.class, orientation);
	}
	...
	protected de.uni_koblenz.jgralab.impl.ReversedEdgeBaseImpl createReversedEdge() {
		return new ReversedIsArgumentOfImpl(this, graph);
	}
