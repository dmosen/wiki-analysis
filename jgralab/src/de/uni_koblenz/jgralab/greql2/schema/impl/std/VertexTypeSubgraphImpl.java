...
public class VertexTypeSubgraphImpl extends VertexImpl implements de.uni_koblenz.jgralab.greql2.schema.SubgraphDefinition, de.uni_koblenz.jgralab.greql2.schema.VertexTypeSubgraph {

	public VertexTypeSubgraphImpl(int id, de.uni_koblenz.jgralab.Graph g) {
		super(id, g);
	}

	@Override
	public final de.uni_koblenz.jgralab.schema.VertexClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.VertexTypeSubgraph.VC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Vertex> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.VertexTypeSubgraph.class;
	}

	public <T> T getAttribute(String attributeName) {
		throw new NoSuchAttributeException("VertexTypeSubgraph doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.VertexTypeSubgraph getNextVertexTypeSubgraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.VertexTypeSubgraph)getNextVertex(de.uni_koblenz.jgralab.greql2.schema.VertexTypeSubgraph.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.Greql2Aggregation getFirstGreql2AggregationIncidence(EdgeDirection orientation) {
		...
		public de.uni_koblenz.jgralab.greql2.schema.IsTypeRestrOfSubgraph add_typeRestr(de.uni_koblenz.jgralab.greql2.schema.TypeId vertex) {
			return ((de.uni_koblenz.jgralab.greql2.schema.Greql2)getGraph()).createEdge(de.uni_koblenz.jgralab.greql2.schema.IsTypeRestrOfSubgraph.EC, (de.uni_koblenz.jgralab.greql2.schema.TypeId) vertex, (de.uni_koblenz.jgralab.greql2.schema.VertexTypeSubgraph) this);
		}
		@Override
