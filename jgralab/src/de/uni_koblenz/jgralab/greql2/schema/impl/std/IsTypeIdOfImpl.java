...
import de.uni_koblenz.jgralab.greql2.schema.impl.std.ReversedIsTypeIdOfImpl;
...
public class IsTypeIdOfImpl extends EdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.Greql2Aggregation, de.uni_koblenz.jgralab.greql2.schema.IsTypeIdOf {

	protected org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions;

	public IsTypeIdOfImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsTypeIdOf.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsTypeIdOf.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("sourcePositions")) return (T) get_sourcePositions();
		throw new NoSuchAttributeException("IsTypeIdOf doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsTypeIdOf getNextIsTypeIdOfInGraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsTypeIdOf)getNextEdge(de.uni_koblenz.jgralab.greql2.schema.IsTypeIdOf.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsTypeIdOf getNextIsTypeIdOfIncidence() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsTypeIdOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsTypeIdOf.class);
	}

	public de.uni_koblenz.jgralab.greql2.schema.IsTypeIdOf getNextIsTypeIdOfIncidence(EdgeDirection orientation) {
		return (de.uni_koblenz.jgralab.greql2.schema.IsTypeIdOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsTypeIdOf.class, orientation);
	}
	...
	protected de.uni_koblenz.jgralab.impl.ReversedEdgeBaseImpl createReversedEdge() {
		return new ReversedIsTypeIdOfImpl(this, graph);
	}
