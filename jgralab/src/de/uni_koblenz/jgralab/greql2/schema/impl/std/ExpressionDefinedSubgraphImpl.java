...
public class ExpressionDefinedSubgraphImpl extends VertexImpl implements de.uni_koblenz.jgralab.greql2.schema.ExpressionDefinedSubgraph, de.uni_koblenz.jgralab.greql2.schema.SubgraphDefinition {

	public ExpressionDefinedSubgraphImpl(int id, de.uni_koblenz.jgralab.Graph g) {
		super(id, g);
	}

	@Override
	public final de.uni_koblenz.jgralab.schema.VertexClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.ExpressionDefinedSubgraph.VC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Vertex> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.ExpressionDefinedSubgraph.class;
	}

	public <T> T getAttribute(String attributeName) {
		throw new NoSuchAttributeException("ExpressionDefinedSubgraph doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.ExpressionDefinedSubgraph getNextExpressionDefinedSubgraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.ExpressionDefinedSubgraph)getNextVertex(de.uni_koblenz.jgralab.greql2.schema.ExpressionDefinedSubgraph.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.Greql2Aggregation getFirstGreql2AggregationIncidence(EdgeDirection orientation) {
		...
		public de.uni_koblenz.jgralab.greql2.schema.IsSubgraphDefiningExpression add_definingExpression(de.uni_koblenz.jgralab.greql2.schema.Expression vertex) {
			return ((de.uni_koblenz.jgralab.greql2.schema.Greql2)getGraph()).createEdge(de.uni_koblenz.jgralab.greql2.schema.IsSubgraphDefiningExpression.EC, (de.uni_koblenz.jgralab.greql2.schema.Expression) vertex, (de.uni_koblenz.jgralab.greql2.schema.ExpressionDefinedSubgraph) this);
		}
		@Override
		public java.util.List<? extends de.uni_koblenz.jgralab.greql2.schema.Expression> remove_definingExpression() {
			...
			de.uni_koblenz.jgralab.greql2.schema.IsSubgraphDefiningExpression edge = (de.uni_koblenz.jgralab.greql2.schema.IsSubgraphDefiningExpression) getFirstIncidence(de.uni_koblenz.jgralab.greql2.schema.IsSubgraphDefiningExpression.class, EdgeDirection.IN);
			while (edge != null) {
				de.uni_koblenz.jgralab.greql2.schema.IsSubgraphDefiningExpression next = (de.uni_koblenz.jgralab.greql2.schema.IsSubgraphDefiningExpression) edge.getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsSubgraphDefiningExpression.class, EdgeDirection.IN);
		...
		public de.uni_koblenz.jgralab.greql2.schema.IsTypeRestrOfSubgraph add_typeRestr(de.uni_koblenz.jgralab.greql2.schema.TypeId vertex) {
			return ((de.uni_koblenz.jgralab.greql2.schema.Greql2)getGraph()).createEdge(de.uni_koblenz.jgralab.greql2.schema.IsTypeRestrOfSubgraph.EC, (de.uni_koblenz.jgralab.greql2.schema.TypeId) vertex, (de.uni_koblenz.jgralab.greql2.schema.ExpressionDefinedSubgraph) this);
		}
		@Override
