...
import de.uni_koblenz.jgralab.greql2.schema.impl.std.ReversedIsValueExprOfComprehensionImpl;
...
public class IsValueExprOfComprehensionImpl extends EdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.Greql2Aggregation, de.uni_koblenz.jgralab.greql2.schema.IsValueExprOfComprehension {

	protected org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions;

	public IsValueExprOfComprehensionImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsValueExprOfComprehension.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsValueExprOfComprehension.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("sourcePositions")) return (T) get_sourcePositions();
		throw new NoSuchAttributeException("IsValueExprOfComprehension doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsValueExprOfComprehension getNextIsValueExprOfComprehensionInGraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsValueExprOfComprehension)getNextEdge(de.uni_koblenz.jgralab.greql2.schema.IsValueExprOfComprehension.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsValueExprOfComprehension getNextIsValueExprOfComprehensionIncidence() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsValueExprOfComprehension)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsValueExprOfComprehension.class);
	}

	public de.uni_koblenz.jgralab.greql2.schema.IsValueExprOfComprehension getNextIsValueExprOfComprehensionIncidence(EdgeDirection orientation) {
		return (de.uni_koblenz.jgralab.greql2.schema.IsValueExprOfComprehension)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsValueExprOfComprehension.class, orientation);
	}
	...
	protected de.uni_koblenz.jgralab.impl.ReversedEdgeBaseImpl createReversedEdge() {
		return new ReversedIsValueExprOfComprehensionImpl(this, graph);
	}
	public Expression getAlpha() {
		return (Expression) super.getAlpha();
	}
	public MapComprehension getOmega() {
		return (MapComprehension) super.getOmega();
	}
}
