...
public class ReversedIsBooleanPredicateOfEdgeRestrictionImpl extends ReversedEdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.Greql2Aggregation, de.uni_koblenz.jgralab.greql2.schema.IsBooleanPredicateOfEdgeRestriction {

	ReversedIsBooleanPredicateOfEdgeRestrictionImpl(EdgeImpl e, Graph g) {
		super(e, g);
	}
	...
	public org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> get_sourcePositions() {
		return ((de.uni_koblenz.jgralab.greql2.schema.IsBooleanPredicateOfEdgeRestriction)normalEdge).get_sourcePositions();
	}
	...
	public void set_sourcePositions(org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions) {
		((de.uni_koblenz.jgralab.greql2.schema.IsBooleanPredicateOfEdgeRestriction)normalEdge).set_sourcePositions(_sourcePositions);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsBooleanPredicateOfEdgeRestriction getNextIsBooleanPredicateOfEdgeRestrictionInGraph() {
		return ((de.uni_koblenz.jgralab.greql2.schema.IsBooleanPredicateOfEdgeRestriction)normalEdge).getNextIsBooleanPredicateOfEdgeRestrictionInGraph();
	}
