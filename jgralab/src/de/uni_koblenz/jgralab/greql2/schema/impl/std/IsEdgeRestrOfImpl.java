...
import de.uni_koblenz.jgralab.greql2.schema.impl.std.ReversedIsEdgeRestrOfImpl;
...
public class IsEdgeRestrOfImpl extends EdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.Greql2Aggregation, de.uni_koblenz.jgralab.greql2.schema.IsEdgeRestrOf {

	protected org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions;

	public IsEdgeRestrOfImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsEdgeRestrOf.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsEdgeRestrOf.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("sourcePositions")) return (T) get_sourcePositions();
		throw new NoSuchAttributeException("IsEdgeRestrOf doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsEdgeRestrOf getNextIsEdgeRestrOfInGraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsEdgeRestrOf)getNextEdge(de.uni_koblenz.jgralab.greql2.schema.IsEdgeRestrOf.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsEdgeRestrOf getNextIsEdgeRestrOfIncidence() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsEdgeRestrOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsEdgeRestrOf.class);
	}

	public de.uni_koblenz.jgralab.greql2.schema.IsEdgeRestrOf getNextIsEdgeRestrOfIncidence(EdgeDirection orientation) {
		return (de.uni_koblenz.jgralab.greql2.schema.IsEdgeRestrOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsEdgeRestrOf.class, orientation);
	}
	...
	protected de.uni_koblenz.jgralab.impl.ReversedEdgeBaseImpl createReversedEdge() {
		return new ReversedIsEdgeRestrOfImpl(this, graph);
	}
	public EdgeRestriction getAlpha() {
		return (EdgeRestriction) super.getAlpha();
	}
	public PrimaryPathDescription getOmega() {
		return (PrimaryPathDescription) super.getOmega();
	}
}
