...
import de.uni_koblenz.jgralab.greql2.schema.impl.std.ReversedIsPathOfImpl;
...
public class IsPathOfImpl extends EdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.Greql2Aggregation, de.uni_koblenz.jgralab.greql2.schema.IsPathOf {

	protected org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions;

	public IsPathOfImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsPathOf.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsPathOf.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("sourcePositions")) return (T) get_sourcePositions();
		throw new NoSuchAttributeException("IsPathOf doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsPathOf getNextIsPathOfInGraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsPathOf)getNextEdge(de.uni_koblenz.jgralab.greql2.schema.IsPathOf.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsPathOf getNextIsPathOfIncidence() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsPathOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsPathOf.class);
	}

	public de.uni_koblenz.jgralab.greql2.schema.IsPathOf getNextIsPathOfIncidence(EdgeDirection orientation) {
		return (de.uni_koblenz.jgralab.greql2.schema.IsPathOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsPathOf.class, orientation);
	}
	...
	protected de.uni_koblenz.jgralab.impl.ReversedEdgeBaseImpl createReversedEdge() {
		return new ReversedIsPathOfImpl(this, graph);
	}
