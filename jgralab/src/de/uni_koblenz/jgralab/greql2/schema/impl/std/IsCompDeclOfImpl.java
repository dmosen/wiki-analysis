...
import de.uni_koblenz.jgralab.greql2.schema.impl.std.ReversedIsCompDeclOfImpl;
 ...
 * FromRoleName : compDecl
 * ToVertexClass: Comprehension
 * ToRoleName : 
 */

public class IsCompDeclOfImpl extends EdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.Greql2Aggregation, de.uni_koblenz.jgralab.greql2.schema.IsCompDeclOf {

	protected org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions;

	public IsCompDeclOfImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsCompDeclOf.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsCompDeclOf.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("sourcePositions")) return (T) get_sourcePositions();
		throw new NoSuchAttributeException("IsCompDeclOf doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsCompDeclOf getNextIsCompDeclOfInGraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsCompDeclOf)getNextEdge(de.uni_koblenz.jgralab.greql2.schema.IsCompDeclOf.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsCompDeclOf getNextIsCompDeclOfIncidence() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsCompDeclOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsCompDeclOf.class);
	}

	public de.uni_koblenz.jgralab.greql2.schema.IsCompDeclOf getNextIsCompDeclOfIncidence(EdgeDirection orientation) {
		return (de.uni_koblenz.jgralab.greql2.schema.IsCompDeclOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsCompDeclOf.class, orientation);
	}
	...
	protected de.uni_koblenz.jgralab.impl.ReversedEdgeBaseImpl createReversedEdge() {
		return new ReversedIsCompDeclOfImpl(this, graph);
	}
