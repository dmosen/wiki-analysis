...
import de.uni_koblenz.jgralab.greql2.schema.impl.std.ReversedIsBoundExprOfDefinitionImpl;
...
public class IsBoundExprOfDefinitionImpl extends EdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.IsBoundExprOf, de.uni_koblenz.jgralab.greql2.schema.IsBoundExprOfDefinition {

	protected org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions;

	public IsBoundExprOfDefinitionImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsBoundExprOfDefinition.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsBoundExprOfDefinition.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("sourcePositions")) return (T) get_sourcePositions();
		throw new NoSuchAttributeException("IsBoundExprOfDefinition doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsBoundExprOfDefinition getNextIsBoundExprOfDefinitionInGraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsBoundExprOfDefinition)getNextEdge(de.uni_koblenz.jgralab.greql2.schema.IsBoundExprOfDefinition.class);
	}
	...
	protected de.uni_koblenz.jgralab.impl.ReversedEdgeBaseImpl createReversedEdge() {
		return new ReversedIsBoundExprOfDefinitionImpl(this, graph);
	}
