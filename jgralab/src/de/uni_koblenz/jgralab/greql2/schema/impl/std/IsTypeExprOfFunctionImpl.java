...
import de.uni_koblenz.jgralab.greql2.schema.impl.std.ReversedIsTypeExprOfFunctionImpl;
...
public class IsTypeExprOfFunctionImpl extends EdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.IsTypeExprOf, de.uni_koblenz.jgralab.greql2.schema.IsTypeExprOfFunction {

	protected org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions;

	public IsTypeExprOfFunctionImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsTypeExprOfFunction.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsTypeExprOfFunction.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("sourcePositions")) return (T) get_sourcePositions();
		throw new NoSuchAttributeException("IsTypeExprOfFunction doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsTypeExprOfFunction getNextIsTypeExprOfFunctionInGraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsTypeExprOfFunction)getNextEdge(de.uni_koblenz.jgralab.greql2.schema.IsTypeExprOfFunction.class);
	}
	...
	protected de.uni_koblenz.jgralab.impl.ReversedEdgeBaseImpl createReversedEdge() {
		return new ReversedIsTypeExprOfFunctionImpl(this, graph);
	}
