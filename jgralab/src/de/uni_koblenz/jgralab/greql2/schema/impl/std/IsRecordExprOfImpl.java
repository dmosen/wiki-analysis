...
import de.uni_koblenz.jgralab.greql2.schema.impl.std.ReversedIsRecordExprOfImpl;
...
public class IsRecordExprOfImpl extends EdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.Greql2Aggregation, de.uni_koblenz.jgralab.greql2.schema.IsRecordExprOf {

	protected org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions;

	public IsRecordExprOfImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsRecordExprOf.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsRecordExprOf.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("sourcePositions")) return (T) get_sourcePositions();
		throw new NoSuchAttributeException("IsRecordExprOf doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsRecordExprOf getNextIsRecordExprOfInGraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsRecordExprOf)getNextEdge(de.uni_koblenz.jgralab.greql2.schema.IsRecordExprOf.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsRecordExprOf getNextIsRecordExprOfIncidence() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsRecordExprOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsRecordExprOf.class);
	}

	public de.uni_koblenz.jgralab.greql2.schema.IsRecordExprOf getNextIsRecordExprOfIncidence(EdgeDirection orientation) {
		return (de.uni_koblenz.jgralab.greql2.schema.IsRecordExprOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsRecordExprOf.class, orientation);
	}
	...
	protected de.uni_koblenz.jgralab.impl.ReversedEdgeBaseImpl createReversedEdge() {
		return new ReversedIsRecordExprOfImpl(this, graph);
	}
