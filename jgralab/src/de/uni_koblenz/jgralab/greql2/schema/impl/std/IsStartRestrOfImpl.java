...
import de.uni_koblenz.jgralab.greql2.schema.impl.std.ReversedIsStartRestrOfImpl;
...
public class IsStartRestrOfImpl extends EdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.Greql2Aggregation, de.uni_koblenz.jgralab.greql2.schema.IsStartRestrOf {

	protected org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions;

	public IsStartRestrOfImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsStartRestrOf.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsStartRestrOf.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("sourcePositions")) return (T) get_sourcePositions();
		throw new NoSuchAttributeException("IsStartRestrOf doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsStartRestrOf getNextIsStartRestrOfInGraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsStartRestrOf)getNextEdge(de.uni_koblenz.jgralab.greql2.schema.IsStartRestrOf.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsStartRestrOf getNextIsStartRestrOfIncidence() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsStartRestrOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsStartRestrOf.class);
	}

	public de.uni_koblenz.jgralab.greql2.schema.IsStartRestrOf getNextIsStartRestrOfIncidence(EdgeDirection orientation) {
		return (de.uni_koblenz.jgralab.greql2.schema.IsStartRestrOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsStartRestrOf.class, orientation);
	}
	...
	protected de.uni_koblenz.jgralab.impl.ReversedEdgeBaseImpl createReversedEdge() {
		return new ReversedIsStartRestrOfImpl(this, graph);
	}
