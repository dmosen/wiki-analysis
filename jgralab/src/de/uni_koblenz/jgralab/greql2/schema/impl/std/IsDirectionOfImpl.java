...
import de.uni_koblenz.jgralab.greql2.schema.impl.std.ReversedIsDirectionOfImpl;
...
public class IsDirectionOfImpl extends EdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.Greql2Aggregation, de.uni_koblenz.jgralab.greql2.schema.IsDirectionOf {

	protected org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions;

	public IsDirectionOfImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsDirectionOf.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsDirectionOf.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("sourcePositions")) return (T) get_sourcePositions();
		throw new NoSuchAttributeException("IsDirectionOf doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsDirectionOf getNextIsDirectionOfInGraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsDirectionOf)getNextEdge(de.uni_koblenz.jgralab.greql2.schema.IsDirectionOf.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsDirectionOf getNextIsDirectionOfIncidence() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsDirectionOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsDirectionOf.class);
	}

	public de.uni_koblenz.jgralab.greql2.schema.IsDirectionOf getNextIsDirectionOfIncidence(EdgeDirection orientation) {
		return (de.uni_koblenz.jgralab.greql2.schema.IsDirectionOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsDirectionOf.class, orientation);
	}
	...
	protected de.uni_koblenz.jgralab.impl.ReversedEdgeBaseImpl createReversedEdge() {
		return new ReversedIsDirectionOfImpl(this, graph);
	}
	public Direction getAlpha() {
		return (Direction) super.getAlpha();
	}
