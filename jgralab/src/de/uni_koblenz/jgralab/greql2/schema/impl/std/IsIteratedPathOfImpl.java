...
import de.uni_koblenz.jgralab.greql2.schema.impl.std.ReversedIsIteratedPathOfImpl;
 ...
 * FromRoleName : iteratedPath
 * ToVertexClass: IteratedPathDescription
 * ToRoleName : 
 */

public class IsIteratedPathOfImpl extends EdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.IsIteratedPathOf, de.uni_koblenz.jgralab.greql2.schema.IsPathDescriptionOf {

	protected org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions;

	public IsIteratedPathOfImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsIteratedPathOf.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsIteratedPathOf.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("sourcePositions")) return (T) get_sourcePositions();
		throw new NoSuchAttributeException("IsIteratedPathOf doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsIteratedPathOf getNextIsIteratedPathOfInGraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsIteratedPathOf)getNextEdge(de.uni_koblenz.jgralab.greql2.schema.IsIteratedPathOf.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsIteratedPathOf getNextIsIteratedPathOfIncidence() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsIteratedPathOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsIteratedPathOf.class);
	}

	public de.uni_koblenz.jgralab.greql2.schema.IsIteratedPathOf getNextIsIteratedPathOfIncidence(EdgeDirection orientation) {
		return (de.uni_koblenz.jgralab.greql2.schema.IsIteratedPathOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsIteratedPathOf.class, orientation);
	}
	...
	protected de.uni_koblenz.jgralab.impl.ReversedEdgeBaseImpl createReversedEdge() {
		return new ReversedIsIteratedPathOfImpl(this, graph);
	}
	public PathDescription getAlpha() {
		return (PathDescription) super.getAlpha();
	}
	public IteratedPathDescription getOmega() {
		return (IteratedPathDescription) super.getOmega();
	}
}
