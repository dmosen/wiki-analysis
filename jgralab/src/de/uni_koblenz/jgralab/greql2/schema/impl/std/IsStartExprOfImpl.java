...
import de.uni_koblenz.jgralab.greql2.schema.impl.std.ReversedIsStartExprOfImpl;
 ...
 * FromRoleName : startExpr
 * ToVertexClass: PathExpression
 * ToRoleName : 
 */

public class IsStartExprOfImpl extends EdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.Greql2Aggregation, de.uni_koblenz.jgralab.greql2.schema.IsStartExprOf {

	protected org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions;

	public IsStartExprOfImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsStartExprOf.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsStartExprOf.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("sourcePositions")) return (T) get_sourcePositions();
		throw new NoSuchAttributeException("IsStartExprOf doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsStartExprOf getNextIsStartExprOfInGraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsStartExprOf)getNextEdge(de.uni_koblenz.jgralab.greql2.schema.IsStartExprOf.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsStartExprOf getNextIsStartExprOfIncidence() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsStartExprOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsStartExprOf.class);
	}

	public de.uni_koblenz.jgralab.greql2.schema.IsStartExprOf getNextIsStartExprOfIncidence(EdgeDirection orientation) {
		return (de.uni_koblenz.jgralab.greql2.schema.IsStartExprOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsStartExprOf.class, orientation);
	}
	...
	protected de.uni_koblenz.jgralab.impl.ReversedEdgeBaseImpl createReversedEdge() {
		return new ReversedIsStartExprOfImpl(this, graph);
	}
	public Expression getAlpha() {
		return (Expression) super.getAlpha();
	}
	public PathExpression getOmega() {
		return (PathExpression) super.getOmega();
	}
}
