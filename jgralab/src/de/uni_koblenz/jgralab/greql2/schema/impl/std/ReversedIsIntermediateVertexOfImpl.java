...
public class ReversedIsIntermediateVertexOfImpl extends ReversedEdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.Greql2Aggregation, de.uni_koblenz.jgralab.greql2.schema.IsIntermediateVertexOf {
	...
	public org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> get_sourcePositions() {
		return ((de.uni_koblenz.jgralab.greql2.schema.IsIntermediateVertexOf)normalEdge).get_sourcePositions();
	}
	...
	public void set_sourcePositions(org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions) {
		((de.uni_koblenz.jgralab.greql2.schema.IsIntermediateVertexOf)normalEdge).set_sourcePositions(_sourcePositions);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsIntermediateVertexOf getNextIsIntermediateVertexOfInGraph() {
		return ((de.uni_koblenz.jgralab.greql2.schema.IsIntermediateVertexOf)normalEdge).getNextIsIntermediateVertexOfInGraph();
	}
