...
import de.uni_koblenz.jgralab.greql2.schema.impl.std.ReversedIsBooleanPredicateOfEdgeRestrictionImpl;
 ...
 * FromRoleName : booleanPredicate
 * ToVertexClass: EdgeRestriction
 * ToRoleName : 
 */

public class IsBooleanPredicateOfEdgeRestrictionImpl extends EdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.Greql2Aggregation, de.uni_koblenz.jgralab.greql2.schema.IsBooleanPredicateOfEdgeRestriction {

	protected org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions;

	public IsBooleanPredicateOfEdgeRestrictionImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsBooleanPredicateOfEdgeRestriction.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsBooleanPredicateOfEdgeRestriction.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("sourcePositions")) return (T) get_sourcePositions();
		throw new NoSuchAttributeException("IsBooleanPredicateOfEdgeRestriction doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsBooleanPredicateOfEdgeRestriction getNextIsBooleanPredicateOfEdgeRestrictionInGraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsBooleanPredicateOfEdgeRestriction)getNextEdge(de.uni_koblenz.jgralab.greql2.schema.IsBooleanPredicateOfEdgeRestriction.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsBooleanPredicateOfEdgeRestriction getNextIsBooleanPredicateOfEdgeRestrictionIncidence() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsBooleanPredicateOfEdgeRestriction)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsBooleanPredicateOfEdgeRestriction.class);
	}

	public de.uni_koblenz.jgralab.greql2.schema.IsBooleanPredicateOfEdgeRestriction getNextIsBooleanPredicateOfEdgeRestrictionIncidence(EdgeDirection orientation) {
		return (de.uni_koblenz.jgralab.greql2.schema.IsBooleanPredicateOfEdgeRestriction)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsBooleanPredicateOfEdgeRestriction.class, orientation);
	}
	...
	protected de.uni_koblenz.jgralab.impl.ReversedEdgeBaseImpl createReversedEdge() {
		return new ReversedIsBooleanPredicateOfEdgeRestrictionImpl(this, graph);
	}
	public Expression getAlpha() {
		return (Expression) super.getAlpha();
	}
	public EdgeRestriction getOmega() {
		return (EdgeRestriction) super.getOmega();
	}
}
