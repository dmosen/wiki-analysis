...
import de.uni_koblenz.jgralab.greql2.schema.impl.std.ReversedIsKeyExprOfComprehensionImpl;
...
public class IsKeyExprOfComprehensionImpl extends EdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.Greql2Aggregation, de.uni_koblenz.jgralab.greql2.schema.IsKeyExprOfComprehension {

	protected org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions;

	public IsKeyExprOfComprehensionImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsKeyExprOfComprehension.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsKeyExprOfComprehension.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("sourcePositions")) return (T) get_sourcePositions();
		throw new NoSuchAttributeException("IsKeyExprOfComprehension doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsKeyExprOfComprehension getNextIsKeyExprOfComprehensionInGraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsKeyExprOfComprehension)getNextEdge(de.uni_koblenz.jgralab.greql2.schema.IsKeyExprOfComprehension.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsKeyExprOfComprehension getNextIsKeyExprOfComprehensionIncidence() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsKeyExprOfComprehension)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsKeyExprOfComprehension.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsKeyExprOfComprehension getNextIsKeyExprOfComprehensionIncidence(EdgeDirection orientation) {
		return (de.uni_koblenz.jgralab.greql2.schema.IsKeyExprOfComprehension)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsKeyExprOfComprehension.class, orientation);
	}
	...
	protected de.uni_koblenz.jgralab.impl.ReversedEdgeBaseImpl createReversedEdge() {
		return new ReversedIsKeyExprOfComprehensionImpl(this, graph);
	}
