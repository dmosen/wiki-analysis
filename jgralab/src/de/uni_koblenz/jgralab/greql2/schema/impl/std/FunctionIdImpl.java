...
public class FunctionIdImpl extends VertexImpl implements de.uni_koblenz.jgralab.greql2.schema.FunctionId, de.uni_koblenz.jgralab.greql2.schema.Identifier {

	protected java.lang.String _name;

	public FunctionIdImpl(int id, de.uni_koblenz.jgralab.Graph g) {
		super(id, g);
	}

	@Override
	public final de.uni_koblenz.jgralab.schema.VertexClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.FunctionId.VC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Vertex> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.FunctionId.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("name")) return (T) get_name();
		throw new NoSuchAttributeException("FunctionId doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.FunctionId getNextFunctionId() {
		return (de.uni_koblenz.jgralab.greql2.schema.FunctionId)getNextVertex(de.uni_koblenz.jgralab.greql2.schema.FunctionId.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsRecordExprOf getFirstIsRecordExprOfIncidence(EdgeDirection orientation) {
		...
		public de.uni_koblenz.jgralab.greql2.schema.IsTypeRestrOfExpression add_typeRestr(de.uni_koblenz.jgralab.greql2.schema.TypeId vertex) {
			return ((de.uni_koblenz.jgralab.greql2.schema.Greql2)getGraph()).createEdge(de.uni_koblenz.jgralab.greql2.schema.IsTypeRestrOfExpression.EC, (de.uni_koblenz.jgralab.greql2.schema.TypeId) vertex, (de.uni_koblenz.jgralab.greql2.schema.FunctionId) this);
		}
		@Override
