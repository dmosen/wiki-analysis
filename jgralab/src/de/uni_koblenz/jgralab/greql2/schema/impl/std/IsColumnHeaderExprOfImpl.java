...
import de.uni_koblenz.jgralab.greql2.schema.impl.std.ReversedIsColumnHeaderExprOfImpl;
...
public class IsColumnHeaderExprOfImpl extends EdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.Greql2Aggregation, de.uni_koblenz.jgralab.greql2.schema.IsColumnHeaderExprOf {

	protected org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions;

	public IsColumnHeaderExprOfImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsColumnHeaderExprOf.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsColumnHeaderExprOf.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("sourcePositions")) return (T) get_sourcePositions();
		throw new NoSuchAttributeException("IsColumnHeaderExprOf doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsColumnHeaderExprOf getNextIsColumnHeaderExprOfInGraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsColumnHeaderExprOf)getNextEdge(de.uni_koblenz.jgralab.greql2.schema.IsColumnHeaderExprOf.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsColumnHeaderExprOf getNextIsColumnHeaderExprOfIncidence() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsColumnHeaderExprOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsColumnHeaderExprOf.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsColumnHeaderExprOf getNextIsColumnHeaderExprOfIncidence(EdgeDirection orientation) {
		return (de.uni_koblenz.jgralab.greql2.schema.IsColumnHeaderExprOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsColumnHeaderExprOf.class, orientation);
	}
	...
	protected de.uni_koblenz.jgralab.impl.ReversedEdgeBaseImpl createReversedEdge() {
		return new ReversedIsColumnHeaderExprOfImpl(this, graph);
	}
