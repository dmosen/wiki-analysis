...
import de.uni_koblenz.jgralab.greql2.schema.impl.std.ReversedIsPartOfImpl;
...
public class IsPartOfImpl extends EdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.Greql2Aggregation, de.uni_koblenz.jgralab.greql2.schema.IsPartOf {

	protected org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions;

	public IsPartOfImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsPartOf.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsPartOf.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("sourcePositions")) return (T) get_sourcePositions();
		throw new NoSuchAttributeException("IsPartOf doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsPartOf getNextIsPartOfInGraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsPartOf)getNextEdge(de.uni_koblenz.jgralab.greql2.schema.IsPartOf.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsPartOf getNextIsPartOfIncidence() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsPartOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsPartOf.class);
	}

	public de.uni_koblenz.jgralab.greql2.schema.IsPartOf getNextIsPartOfIncidence(EdgeDirection orientation) {
		return (de.uni_koblenz.jgralab.greql2.schema.IsPartOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsPartOf.class, orientation);
	}
	...
	protected de.uni_koblenz.jgralab.impl.ReversedEdgeBaseImpl createReversedEdge() {
		return new ReversedIsPartOfImpl(this, graph);
	}
	public Expression getAlpha() {
		return (Expression) super.getAlpha();
	}
	public ValueConstruction getOmega() {
		return (ValueConstruction) super.getOmega();
	}
}
