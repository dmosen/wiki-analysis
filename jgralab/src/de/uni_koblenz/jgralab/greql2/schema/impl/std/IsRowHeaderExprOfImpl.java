...
import de.uni_koblenz.jgralab.greql2.schema.impl.std.ReversedIsRowHeaderExprOfImpl;
...
public class IsRowHeaderExprOfImpl extends EdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.Greql2Aggregation, de.uni_koblenz.jgralab.greql2.schema.IsRowHeaderExprOf {

	protected org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions;

	public IsRowHeaderExprOfImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsRowHeaderExprOf.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsRowHeaderExprOf.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("sourcePositions")) return (T) get_sourcePositions();
		throw new NoSuchAttributeException("IsRowHeaderExprOf doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsRowHeaderExprOf getNextIsRowHeaderExprOfInGraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsRowHeaderExprOf)getNextEdge(de.uni_koblenz.jgralab.greql2.schema.IsRowHeaderExprOf.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsRowHeaderExprOf getNextIsRowHeaderExprOfIncidence() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsRowHeaderExprOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsRowHeaderExprOf.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsRowHeaderExprOf getNextIsRowHeaderExprOfIncidence(EdgeDirection orientation) {
		return (de.uni_koblenz.jgralab.greql2.schema.IsRowHeaderExprOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsRowHeaderExprOf.class, orientation);
	}
	...
	protected de.uni_koblenz.jgralab.impl.ReversedEdgeBaseImpl createReversedEdge() {
		return new ReversedIsRowHeaderExprOfImpl(this, graph);
	}
	public Expression getAlpha() {
		return (Expression) super.getAlpha();
	}
	public TableComprehension getOmega() {
		return (TableComprehension) super.getOmega();
	}
}
