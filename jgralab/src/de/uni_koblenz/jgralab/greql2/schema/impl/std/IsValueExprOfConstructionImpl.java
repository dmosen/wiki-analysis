...
import de.uni_koblenz.jgralab.greql2.schema.impl.std.ReversedIsValueExprOfConstructionImpl;
...
public class IsValueExprOfConstructionImpl extends EdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.Greql2Aggregation, de.uni_koblenz.jgralab.greql2.schema.IsValueExprOfConstruction {

	protected org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions;

	public IsValueExprOfConstructionImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsValueExprOfConstruction.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsValueExprOfConstruction.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("sourcePositions")) return (T) get_sourcePositions();
		throw new NoSuchAttributeException("IsValueExprOfConstruction doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsValueExprOfConstruction getNextIsValueExprOfConstructionInGraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsValueExprOfConstruction)getNextEdge(de.uni_koblenz.jgralab.greql2.schema.IsValueExprOfConstruction.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsValueExprOfConstruction getNextIsValueExprOfConstructionIncidence() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsValueExprOfConstruction)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsValueExprOfConstruction.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsValueExprOfConstruction getNextIsValueExprOfConstructionIncidence(EdgeDirection orientation) {
		return (de.uni_koblenz.jgralab.greql2.schema.IsValueExprOfConstruction)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsValueExprOfConstruction.class, orientation);
	}
	...
	protected de.uni_koblenz.jgralab.impl.ReversedEdgeBaseImpl createReversedEdge() {
		return new ReversedIsValueExprOfConstructionImpl(this, graph);
	}
