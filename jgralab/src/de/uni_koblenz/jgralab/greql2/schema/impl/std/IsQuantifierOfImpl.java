...
import de.uni_koblenz.jgralab.greql2.schema.impl.std.ReversedIsQuantifierOfImpl;
 ...
 * FromRoleName : quantifier
 * ToVertexClass: QuantifiedExpression
 * ToRoleName : 
 */

public class IsQuantifierOfImpl extends EdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.Greql2Aggregation, de.uni_koblenz.jgralab.greql2.schema.IsQuantifierOf {

	protected org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions;

	public IsQuantifierOfImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsQuantifierOf.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsQuantifierOf.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("sourcePositions")) return (T) get_sourcePositions();
		throw new NoSuchAttributeException("IsQuantifierOf doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsQuantifierOf getNextIsQuantifierOfInGraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsQuantifierOf)getNextEdge(de.uni_koblenz.jgralab.greql2.schema.IsQuantifierOf.class);
	}
	...
	protected de.uni_koblenz.jgralab.impl.ReversedEdgeBaseImpl createReversedEdge() {
		return new ReversedIsQuantifierOfImpl(this, graph);
	}
