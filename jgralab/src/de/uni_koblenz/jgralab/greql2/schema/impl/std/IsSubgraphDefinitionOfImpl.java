...
import de.uni_koblenz.jgralab.greql2.schema.impl.std.ReversedIsSubgraphDefinitionOfImpl;
...
public class IsSubgraphDefinitionOfImpl extends EdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.Greql2Aggregation, de.uni_koblenz.jgralab.greql2.schema.IsSubgraphDefinitionOf {

	protected org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions;

	public IsSubgraphDefinitionOfImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsSubgraphDefinitionOf.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsSubgraphDefinitionOf.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("sourcePositions")) return (T) get_sourcePositions();
		throw new NoSuchAttributeException("IsSubgraphDefinitionOf doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsSubgraphDefinitionOf getNextIsSubgraphDefinitionOfInGraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsSubgraphDefinitionOf)getNextEdge(de.uni_koblenz.jgralab.greql2.schema.IsSubgraphDefinitionOf.class);
	}
	...
	protected de.uni_koblenz.jgralab.impl.ReversedEdgeBaseImpl createReversedEdge() {
		return new ReversedIsSubgraphDefinitionOfImpl(this, graph);
	}
