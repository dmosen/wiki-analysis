...
public class ReversedIsStartExprOfImpl extends ReversedEdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.Greql2Aggregation, de.uni_koblenz.jgralab.greql2.schema.IsStartExprOf {
	...
	public org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> get_sourcePositions() {
		return ((de.uni_koblenz.jgralab.greql2.schema.IsStartExprOf)normalEdge).get_sourcePositions();
	}
	...
	public void set_sourcePositions(org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions) {
		((de.uni_koblenz.jgralab.greql2.schema.IsStartExprOf)normalEdge).set_sourcePositions(_sourcePositions);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsStartExprOf getNextIsStartExprOfInGraph() {
		return ((de.uni_koblenz.jgralab.greql2.schema.IsStartExprOf)normalEdge).getNextIsStartExprOfInGraph();
	}
