...
import de.uni_koblenz.jgralab.greql2.schema.impl.std.ReversedIsExprOfImpl;
...
public class IsExprOfImpl extends EdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.Greql2Aggregation, de.uni_koblenz.jgralab.greql2.schema.IsExprOf {

	protected org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions;

	public IsExprOfImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsExprOf.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsExprOf.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("sourcePositions")) return (T) get_sourcePositions();
		throw new NoSuchAttributeException("IsExprOf doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsExprOf getNextIsExprOfInGraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsExprOf)getNextEdge(de.uni_koblenz.jgralab.greql2.schema.IsExprOf.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsExprOf getNextIsExprOfIncidence() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsExprOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsExprOf.class);
	}

	public de.uni_koblenz.jgralab.greql2.schema.IsExprOf getNextIsExprOfIncidence(EdgeDirection orientation) {
		return (de.uni_koblenz.jgralab.greql2.schema.IsExprOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsExprOf.class, orientation);
	}
	...
	protected de.uni_koblenz.jgralab.impl.ReversedEdgeBaseImpl createReversedEdge() {
		return new ReversedIsExprOfImpl(this, graph);
	}
	public Expression getAlpha() {
		return (Expression) super.getAlpha();
	}
	public Definition getOmega() {
		return (Definition) super.getOmega();
	}
}
