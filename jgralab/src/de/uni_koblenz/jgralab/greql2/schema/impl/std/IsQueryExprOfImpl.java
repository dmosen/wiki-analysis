...
import de.uni_koblenz.jgralab.greql2.schema.impl.std.ReversedIsQueryExprOfImpl;
...
public class IsQueryExprOfImpl extends EdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.Greql2Aggregation, de.uni_koblenz.jgralab.greql2.schema.IsQueryExprOf {

	protected org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions;

	public IsQueryExprOfImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsQueryExprOf.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsQueryExprOf.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("sourcePositions")) return (T) get_sourcePositions();
		throw new NoSuchAttributeException("IsQueryExprOf doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsQueryExprOf getNextIsQueryExprOfInGraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsQueryExprOf)getNextEdge(de.uni_koblenz.jgralab.greql2.schema.IsQueryExprOf.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsQueryExprOf getNextIsQueryExprOfIncidence() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsQueryExprOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsQueryExprOf.class);
	}

	public de.uni_koblenz.jgralab.greql2.schema.IsQueryExprOf getNextIsQueryExprOfIncidence(EdgeDirection orientation) {
		return (de.uni_koblenz.jgralab.greql2.schema.IsQueryExprOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsQueryExprOf.class, orientation);
	}
	...
	protected de.uni_koblenz.jgralab.impl.ReversedEdgeBaseImpl createReversedEdge() {
		return new ReversedIsQueryExprOfImpl(this, graph);
	}
