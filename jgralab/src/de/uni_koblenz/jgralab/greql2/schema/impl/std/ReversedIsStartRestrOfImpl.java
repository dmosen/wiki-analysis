...
public class ReversedIsStartRestrOfImpl extends ReversedEdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.Greql2Aggregation, de.uni_koblenz.jgralab.greql2.schema.IsStartRestrOf {
	...
	public org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> get_sourcePositions() {
		return ((de.uni_koblenz.jgralab.greql2.schema.IsStartRestrOf)normalEdge).get_sourcePositions();
	}
	...
	public void set_sourcePositions(org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions) {
		((de.uni_koblenz.jgralab.greql2.schema.IsStartRestrOf)normalEdge).set_sourcePositions(_sourcePositions);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsStartRestrOf getNextIsStartRestrOfInGraph() {
		return ((de.uni_koblenz.jgralab.greql2.schema.IsStartRestrOf)normalEdge).getNextIsStartRestrOfInGraph();
	}
