...
import de.uni_koblenz.jgralab.greql2.schema.impl.std.ReversedIsDeclaredVarOfImpl;
 ...
 * FromRoleName : declaredVar
 * ToVertexClass: SimpleDeclaration
 * ToRoleName : 
 */

public class IsDeclaredVarOfImpl extends EdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.Greql2Aggregation, de.uni_koblenz.jgralab.greql2.schema.IsDeclaredVarOf {

	protected org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions;

	public IsDeclaredVarOfImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsDeclaredVarOf.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsDeclaredVarOf.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("sourcePositions")) return (T) get_sourcePositions();
		throw new NoSuchAttributeException("IsDeclaredVarOf doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsDeclaredVarOf getNextIsDeclaredVarOfInGraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsDeclaredVarOf)getNextEdge(de.uni_koblenz.jgralab.greql2.schema.IsDeclaredVarOf.class);
	}
	...
	protected de.uni_koblenz.jgralab.impl.ReversedEdgeBaseImpl createReversedEdge() {
		return new ReversedIsDeclaredVarOfImpl(this, graph);
	}
