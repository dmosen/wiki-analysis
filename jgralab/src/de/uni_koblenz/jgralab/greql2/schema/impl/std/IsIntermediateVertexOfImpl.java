...
import de.uni_koblenz.jgralab.greql2.schema.impl.std.ReversedIsIntermediateVertexOfImpl;
 ...
 * FromRoleName : intermediateVertex
 * ToVertexClass: IntermediateVertexPathDescription
 * ToRoleName : 
 */

public class IsIntermediateVertexOfImpl extends EdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.Greql2Aggregation, de.uni_koblenz.jgralab.greql2.schema.IsIntermediateVertexOf {

	protected org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions;

	public IsIntermediateVertexOfImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsIntermediateVertexOf.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsIntermediateVertexOf.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("sourcePositions")) return (T) get_sourcePositions();
		throw new NoSuchAttributeException("IsIntermediateVertexOf doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsIntermediateVertexOf getNextIsIntermediateVertexOfInGraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsIntermediateVertexOf)getNextEdge(de.uni_koblenz.jgralab.greql2.schema.IsIntermediateVertexOf.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsIntermediateVertexOf getNextIsIntermediateVertexOfIncidence() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsIntermediateVertexOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsIntermediateVertexOf.class);
	}

	public de.uni_koblenz.jgralab.greql2.schema.IsIntermediateVertexOf getNextIsIntermediateVertexOfIncidence(EdgeDirection orientation) {
		return (de.uni_koblenz.jgralab.greql2.schema.IsIntermediateVertexOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsIntermediateVertexOf.class, orientation);
	}
	...
	protected de.uni_koblenz.jgralab.impl.ReversedEdgeBaseImpl createReversedEdge() {
		return new ReversedIsIntermediateVertexOfImpl(this, graph);
	}
