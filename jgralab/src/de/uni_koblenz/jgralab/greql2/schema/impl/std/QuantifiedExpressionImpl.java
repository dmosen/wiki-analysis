...
public class QuantifiedExpressionImpl extends VertexImpl implements de.uni_koblenz.jgralab.greql2.schema.Expression, de.uni_koblenz.jgralab.greql2.schema.QuantifiedExpression {

	public QuantifiedExpressionImpl(int id, de.uni_koblenz.jgralab.Graph g) {
		super(id, g);
	}

	@Override
	public final de.uni_koblenz.jgralab.schema.VertexClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.QuantifiedExpression.VC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Vertex> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.QuantifiedExpression.class;
	}

	public <T> T getAttribute(String attributeName) {
		throw new NoSuchAttributeException("QuantifiedExpression doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.QuantifiedExpression getNextQuantifiedExpression() {
		return (de.uni_koblenz.jgralab.greql2.schema.QuantifiedExpression)getNextVertex(de.uni_koblenz.jgralab.greql2.schema.QuantifiedExpression.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsRecordExprOf getFirstIsRecordExprOfIncidence(EdgeDirection orientation) {
		...
		public de.uni_koblenz.jgralab.greql2.schema.IsTypeRestrOfExpression add_typeRestr(de.uni_koblenz.jgralab.greql2.schema.TypeId vertex) {
			return ((de.uni_koblenz.jgralab.greql2.schema.Greql2)getGraph()).createEdge(de.uni_koblenz.jgralab.greql2.schema.IsTypeRestrOfExpression.EC, (de.uni_koblenz.jgralab.greql2.schema.TypeId) vertex, (de.uni_koblenz.jgralab.greql2.schema.QuantifiedExpression) this);
		}
		@Override
		...
		public de.uni_koblenz.jgralab.greql2.schema.IsBoundExprOfQuantifier add_boundExprOfQuantifier(de.uni_koblenz.jgralab.greql2.schema.Expression vertex) {
			return ((de.uni_koblenz.jgralab.greql2.schema.Greql2)getGraph()).createEdge(de.uni_koblenz.jgralab.greql2.schema.IsBoundExprOfQuantifier.EC, (de.uni_koblenz.jgralab.greql2.schema.Expression) vertex, (de.uni_koblenz.jgralab.greql2.schema.QuantifiedExpression) this);
		}
		@Override
		public java.util.List<? extends de.uni_koblenz.jgralab.greql2.schema.Expression> remove_boundExprOfQuantifier() {
			...
			de.uni_koblenz.jgralab.greql2.schema.IsBoundExprOfQuantifier edge = (de.uni_koblenz.jgralab.greql2.schema.IsBoundExprOfQuantifier) getFirstIncidence(de.uni_koblenz.jgralab.greql2.schema.IsBoundExprOfQuantifier.class, EdgeDirection.IN);
			while (edge != null) {
				de.uni_koblenz.jgralab.greql2.schema.IsBoundExprOfQuantifier next = (de.uni_koblenz.jgralab.greql2.schema.IsBoundExprOfQuantifier) edge.getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsBoundExprOfQuantifier.class, EdgeDirection.IN);
		...
		public de.uni_koblenz.jgralab.greql2.schema.IsQuantifiedDeclOf add_quantifiedDecl(de.uni_koblenz.jgralab.greql2.schema.Declaration vertex) {
			return ((de.uni_koblenz.jgralab.greql2.schema.Greql2)getGraph()).createEdge(de.uni_koblenz.jgralab.greql2.schema.IsQuantifiedDeclOf.EC, (de.uni_koblenz.jgralab.greql2.schema.Declaration) vertex, (de.uni_koblenz.jgralab.greql2.schema.QuantifiedExpression) this);
		}
		@Override
		public java.util.List<? extends de.uni_koblenz.jgralab.greql2.schema.Declaration> remove_quantifiedDecl() {
			...
			de.uni_koblenz.jgralab.greql2.schema.IsQuantifiedDeclOf edge = (de.uni_koblenz.jgralab.greql2.schema.IsQuantifiedDeclOf) getFirstIncidence(de.uni_koblenz.jgralab.greql2.schema.IsQuantifiedDeclOf.class, EdgeDirection.IN);
			while (edge != null) {
				de.uni_koblenz.jgralab.greql2.schema.IsQuantifiedDeclOf next = (de.uni_koblenz.jgralab.greql2.schema.IsQuantifiedDeclOf) edge.getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsQuantifiedDeclOf.class, EdgeDirection.IN);
		...
		public de.uni_koblenz.jgralab.greql2.schema.IsQuantifierOf add_quantifier(de.uni_koblenz.jgralab.greql2.schema.Quantifier vertex) {
			return ((de.uni_koblenz.jgralab.greql2.schema.Greql2)getGraph()).createEdge(de.uni_koblenz.jgralab.greql2.schema.IsQuantifierOf.EC, (de.uni_koblenz.jgralab.greql2.schema.Quantifier) vertex, (de.uni_koblenz.jgralab.greql2.schema.QuantifiedExpression) this);
		}
		@Override
		public java.util.List<? extends de.uni_koblenz.jgralab.greql2.schema.Quantifier> remove_quantifier() {
			java.util.List<de.uni_koblenz.jgralab.greql2.schema.Quantifier> adjacences = new java.util.ArrayList<de.uni_koblenz.jgralab.greql2.schema.Quantifier>();
			de.uni_koblenz.jgralab.greql2.schema.IsQuantifierOf edge = (de.uni_koblenz.jgralab.greql2.schema.IsQuantifierOf) getFirstIncidence(de.uni_koblenz.jgralab.greql2.schema.IsQuantifierOf.class, EdgeDirection.IN);
			while (edge != null) {
				de.uni_koblenz.jgralab.greql2.schema.IsQuantifierOf next = (de.uni_koblenz.jgralab.greql2.schema.IsQuantifierOf) edge.getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsQuantifierOf.class, EdgeDirection.IN);
				adjacences.add((de.uni_koblenz.jgralab.greql2.schema.Quantifier) edge.getThat());
				edge.delete();
				edge = next;
			}
			return adjacences;
		...
		public de.uni_koblenz.jgralab.greql2.schema.Quantifier get_quantifier() {
			de.uni_koblenz.jgralab.greql2.schema.IsQuantifierOf edge = (de.uni_koblenz.jgralab.greql2.schema.IsQuantifierOf) getFirstIncidence(de.uni_koblenz.jgralab.greql2.schema.IsQuantifierOf.class, EdgeDirection.IN);
			if (edge != null) {
				return (de.uni_koblenz.jgralab.greql2.schema.Quantifier) edge.getThat();
			}
			return null;
		}
