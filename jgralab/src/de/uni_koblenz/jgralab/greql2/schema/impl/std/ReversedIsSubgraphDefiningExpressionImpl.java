...
public class ReversedIsSubgraphDefiningExpressionImpl extends ReversedEdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.Greql2Aggregation, de.uni_koblenz.jgralab.greql2.schema.IsSubgraphDefiningExpression {

	ReversedIsSubgraphDefiningExpressionImpl(EdgeImpl e, Graph g) {
		super(e, g);
	}
	...
	public org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> get_sourcePositions() {
		return ((de.uni_koblenz.jgralab.greql2.schema.IsSubgraphDefiningExpression)normalEdge).get_sourcePositions();
	}
	...
	public void set_sourcePositions(org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions) {
		((de.uni_koblenz.jgralab.greql2.schema.IsSubgraphDefiningExpression)normalEdge).set_sourcePositions(_sourcePositions);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsSubgraphDefiningExpression getNextIsSubgraphDefiningExpressionInGraph() {
		return ((de.uni_koblenz.jgralab.greql2.schema.IsSubgraphDefiningExpression)normalEdge).getNextIsSubgraphDefiningExpressionInGraph();
	}
