...
import de.uni_koblenz.jgralab.greql2.schema.impl.std.ReversedIsRoleIdOfImpl;
...
public class IsRoleIdOfImpl extends EdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.Greql2Aggregation, de.uni_koblenz.jgralab.greql2.schema.IsRoleIdOf {

	protected org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions;

	public IsRoleIdOfImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsRoleIdOf.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsRoleIdOf.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("sourcePositions")) return (T) get_sourcePositions();
		throw new NoSuchAttributeException("IsRoleIdOf doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsRoleIdOf getNextIsRoleIdOfInGraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsRoleIdOf)getNextEdge(de.uni_koblenz.jgralab.greql2.schema.IsRoleIdOf.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsRoleIdOf getNextIsRoleIdOfIncidence() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsRoleIdOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsRoleIdOf.class);
	}

	public de.uni_koblenz.jgralab.greql2.schema.IsRoleIdOf getNextIsRoleIdOfIncidence(EdgeDirection orientation) {
		return (de.uni_koblenz.jgralab.greql2.schema.IsRoleIdOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsRoleIdOf.class, orientation);
	}
	...
	protected de.uni_koblenz.jgralab.impl.ReversedEdgeBaseImpl createReversedEdge() {
		return new ReversedIsRoleIdOfImpl(this, graph);
	}
	public RoleId getAlpha() {
		return (RoleId) super.getAlpha();
	}
