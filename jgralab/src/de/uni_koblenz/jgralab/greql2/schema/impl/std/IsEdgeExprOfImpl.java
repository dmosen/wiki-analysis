...
import de.uni_koblenz.jgralab.greql2.schema.impl.std.ReversedIsEdgeExprOfImpl;
...
public class IsEdgeExprOfImpl extends EdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.Greql2Aggregation, de.uni_koblenz.jgralab.greql2.schema.IsEdgeExprOf {

	protected org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions;

	public IsEdgeExprOfImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsEdgeExprOf.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsEdgeExprOf.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("sourcePositions")) return (T) get_sourcePositions();
		throw new NoSuchAttributeException("IsEdgeExprOf doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsEdgeExprOf getNextIsEdgeExprOfInGraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsEdgeExprOf)getNextEdge(de.uni_koblenz.jgralab.greql2.schema.IsEdgeExprOf.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsEdgeExprOf getNextIsEdgeExprOfIncidence() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsEdgeExprOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsEdgeExprOf.class);
	}

	public de.uni_koblenz.jgralab.greql2.schema.IsEdgeExprOf getNextIsEdgeExprOfIncidence(EdgeDirection orientation) {
		return (de.uni_koblenz.jgralab.greql2.schema.IsEdgeExprOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsEdgeExprOf.class, orientation);
	}
	...
	protected de.uni_koblenz.jgralab.impl.ReversedEdgeBaseImpl createReversedEdge() {
		return new ReversedIsEdgeExprOfImpl(this, graph);
	}
	public Expression getAlpha() {
		return (Expression) super.getAlpha();
	}
	public EdgePathDescription getOmega() {
		return (EdgePathDescription) super.getOmega();
	}
}
