...
import de.uni_koblenz.jgralab.greql2.schema.impl.std.ReversedIsGoalRestrOfImpl;
...
public class IsGoalRestrOfImpl extends EdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.Greql2Aggregation, de.uni_koblenz.jgralab.greql2.schema.IsGoalRestrOf {

	protected org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions;

	public IsGoalRestrOfImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsGoalRestrOf.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsGoalRestrOf.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("sourcePositions")) return (T) get_sourcePositions();
		throw new NoSuchAttributeException("IsGoalRestrOf doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsGoalRestrOf getNextIsGoalRestrOfInGraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsGoalRestrOf)getNextEdge(de.uni_koblenz.jgralab.greql2.schema.IsGoalRestrOf.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsGoalRestrOf getNextIsGoalRestrOfIncidence() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsGoalRestrOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsGoalRestrOf.class);
	}

	public de.uni_koblenz.jgralab.greql2.schema.IsGoalRestrOf getNextIsGoalRestrOfIncidence(EdgeDirection orientation) {
		return (de.uni_koblenz.jgralab.greql2.schema.IsGoalRestrOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsGoalRestrOf.class, orientation);
	}
	...
	protected de.uni_koblenz.jgralab.impl.ReversedEdgeBaseImpl createReversedEdge() {
		return new ReversedIsGoalRestrOfImpl(this, graph);
	}
