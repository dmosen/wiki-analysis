...
import de.uni_koblenz.jgralab.greql2.schema.impl.std.ReversedIsSubgraphDefiningExpressionImpl;
 ...
 * FromRoleName : definingExpression
 * ToVertexClass: ExpressionDefinedSubgraph
 * ToRoleName : 
 */

public class IsSubgraphDefiningExpressionImpl extends EdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.Greql2Aggregation, de.uni_koblenz.jgralab.greql2.schema.IsSubgraphDefiningExpression {

	protected org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions;

	public IsSubgraphDefiningExpressionImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsSubgraphDefiningExpression.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsSubgraphDefiningExpression.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("sourcePositions")) return (T) get_sourcePositions();
		throw new NoSuchAttributeException("IsSubgraphDefiningExpression doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsSubgraphDefiningExpression getNextIsSubgraphDefiningExpressionInGraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsSubgraphDefiningExpression)getNextEdge(de.uni_koblenz.jgralab.greql2.schema.IsSubgraphDefiningExpression.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsSubgraphDefiningExpression getNextIsSubgraphDefiningExpressionIncidence() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsSubgraphDefiningExpression)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsSubgraphDefiningExpression.class);
	}

	public de.uni_koblenz.jgralab.greql2.schema.IsSubgraphDefiningExpression getNextIsSubgraphDefiningExpressionIncidence(EdgeDirection orientation) {
		return (de.uni_koblenz.jgralab.greql2.schema.IsSubgraphDefiningExpression)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsSubgraphDefiningExpression.class, orientation);
	}
	...
	protected de.uni_koblenz.jgralab.impl.ReversedEdgeBaseImpl createReversedEdge() {
		return new ReversedIsSubgraphDefiningExpressionImpl(this, graph);
	}
	public Expression getAlpha() {
		return (Expression) super.getAlpha();
	}
	public ExpressionDefinedSubgraph getOmega() {
		return (ExpressionDefinedSubgraph) super.getOmega();
	}
}
