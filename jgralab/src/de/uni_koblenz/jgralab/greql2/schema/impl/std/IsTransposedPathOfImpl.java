...
import de.uni_koblenz.jgralab.greql2.schema.impl.std.ReversedIsTransposedPathOfImpl;
...
public class IsTransposedPathOfImpl extends EdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.IsPathDescriptionOf, de.uni_koblenz.jgralab.greql2.schema.IsTransposedPathOf {

	protected org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions;

	public IsTransposedPathOfImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsTransposedPathOf.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsTransposedPathOf.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("sourcePositions")) return (T) get_sourcePositions();
		throw new NoSuchAttributeException("IsTransposedPathOf doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsTransposedPathOf getNextIsTransposedPathOfInGraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsTransposedPathOf)getNextEdge(de.uni_koblenz.jgralab.greql2.schema.IsTransposedPathOf.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsTransposedPathOf getNextIsTransposedPathOfIncidence() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsTransposedPathOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsTransposedPathOf.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsTransposedPathOf getNextIsTransposedPathOfIncidence(EdgeDirection orientation) {
		return (de.uni_koblenz.jgralab.greql2.schema.IsTransposedPathOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsTransposedPathOf.class, orientation);
	}
