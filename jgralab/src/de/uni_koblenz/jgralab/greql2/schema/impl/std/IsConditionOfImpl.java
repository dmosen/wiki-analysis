...
import de.uni_koblenz.jgralab.greql2.schema.impl.std.ReversedIsConditionOfImpl;
 ...
 * FromRoleName : condition
 * ToVertexClass: ConditionalExpression
 * ToRoleName : 
 */

public class IsConditionOfImpl extends EdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.Greql2Aggregation, de.uni_koblenz.jgralab.greql2.schema.IsConditionOf {

	protected org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions;

	public IsConditionOfImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsConditionOf.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsConditionOf.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("sourcePositions")) return (T) get_sourcePositions();
		throw new NoSuchAttributeException("IsConditionOf doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsConditionOf getNextIsConditionOfInGraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsConditionOf)getNextEdge(de.uni_koblenz.jgralab.greql2.schema.IsConditionOf.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsConditionOf getNextIsConditionOfIncidence() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsConditionOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsConditionOf.class);
	}

	public de.uni_koblenz.jgralab.greql2.schema.IsConditionOf getNextIsConditionOfIncidence(EdgeDirection orientation) {
		return (de.uni_koblenz.jgralab.greql2.schema.IsConditionOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsConditionOf.class, orientation);
	}
	...
	protected de.uni_koblenz.jgralab.impl.ReversedEdgeBaseImpl createReversedEdge() {
		return new ReversedIsConditionOfImpl(this, graph);
	}
