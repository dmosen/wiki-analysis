...
public class RoleIdImpl extends VertexImpl implements de.uni_koblenz.jgralab.greql2.schema.RoleId, de.uni_koblenz.jgralab.greql2.schema.TypeOrRoleId {

	protected java.lang.String _name;

	public RoleIdImpl(int id, de.uni_koblenz.jgralab.Graph g) {
		super(id, g);
	}

	@Override
	public final de.uni_koblenz.jgralab.schema.VertexClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.RoleId.VC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Vertex> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.RoleId.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("name")) return (T) get_name();
		throw new NoSuchAttributeException("RoleId doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.RoleId getNextRoleId() {
		return (de.uni_koblenz.jgralab.greql2.schema.RoleId)getNextVertex(de.uni_koblenz.jgralab.greql2.schema.RoleId.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsRecordExprOf getFirstIsRecordExprOfIncidence(EdgeDirection orientation) {
		...
		public de.uni_koblenz.jgralab.greql2.schema.IsTypeRestrOfExpression add_typeRestr(de.uni_koblenz.jgralab.greql2.schema.TypeId vertex) {
			return ((de.uni_koblenz.jgralab.greql2.schema.Greql2)getGraph()).createEdge(de.uni_koblenz.jgralab.greql2.schema.IsTypeRestrOfExpression.EC, (de.uni_koblenz.jgralab.greql2.schema.TypeId) vertex, (de.uni_koblenz.jgralab.greql2.schema.RoleId) this);
		}
		@Override
