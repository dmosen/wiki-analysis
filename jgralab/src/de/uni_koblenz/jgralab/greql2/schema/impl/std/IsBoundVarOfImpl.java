...
import de.uni_koblenz.jgralab.greql2.schema.impl.std.ReversedIsBoundVarOfImpl;
 ...
 * FromRoleName : boundVar
 * ToVertexClass: Greql2Expression
 * ToRoleName : 
 */

public class IsBoundVarOfImpl extends EdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.Greql2Aggregation, de.uni_koblenz.jgralab.greql2.schema.IsBoundVarOf {

	protected org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions;

	public IsBoundVarOfImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsBoundVarOf.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsBoundVarOf.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("sourcePositions")) return (T) get_sourcePositions();
		throw new NoSuchAttributeException("IsBoundVarOf doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsBoundVarOf getNextIsBoundVarOfInGraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsBoundVarOf)getNextEdge(de.uni_koblenz.jgralab.greql2.schema.IsBoundVarOf.class);
	}
	...
	protected de.uni_koblenz.jgralab.impl.ReversedEdgeBaseImpl createReversedEdge() {
		return new ReversedIsBoundVarOfImpl(this, graph);
	}
