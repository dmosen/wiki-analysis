...
import de.uni_koblenz.jgralab.greql2.schema.impl.std.ReversedIsSequenceElementOfImpl;
...
public class IsSequenceElementOfImpl extends EdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.IsPathDescriptionOf, de.uni_koblenz.jgralab.greql2.schema.IsSequenceElementOf {

	protected org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions;

	public IsSequenceElementOfImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsSequenceElementOf.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsSequenceElementOf.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("sourcePositions")) return (T) get_sourcePositions();
		throw new NoSuchAttributeException("IsSequenceElementOf doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsSequenceElementOf getNextIsSequenceElementOfInGraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsSequenceElementOf)getNextEdge(de.uni_koblenz.jgralab.greql2.schema.IsSequenceElementOf.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsSequenceElementOf getNextIsSequenceElementOfIncidence() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsSequenceElementOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsSequenceElementOf.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsSequenceElementOf getNextIsSequenceElementOfIncidence(EdgeDirection orientation) {
		return (de.uni_koblenz.jgralab.greql2.schema.IsSequenceElementOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsSequenceElementOf.class, orientation);
	}
