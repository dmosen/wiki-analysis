...
import de.uni_koblenz.jgralab.greql2.schema.impl.std.ReversedIsTableHeaderOfImpl;
...
public class IsTableHeaderOfImpl extends EdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.Greql2Aggregation, de.uni_koblenz.jgralab.greql2.schema.IsTableHeaderOf {

	protected org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions;

	public IsTableHeaderOfImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsTableHeaderOf.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsTableHeaderOf.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("sourcePositions")) return (T) get_sourcePositions();
		throw new NoSuchAttributeException("IsTableHeaderOf doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsTableHeaderOf getNextIsTableHeaderOfInGraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsTableHeaderOf)getNextEdge(de.uni_koblenz.jgralab.greql2.schema.IsTableHeaderOf.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsTableHeaderOf getNextIsTableHeaderOfIncidence() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsTableHeaderOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsTableHeaderOf.class);
	}

	public de.uni_koblenz.jgralab.greql2.schema.IsTableHeaderOf getNextIsTableHeaderOfIncidence(EdgeDirection orientation) {
		return (de.uni_koblenz.jgralab.greql2.schema.IsTableHeaderOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsTableHeaderOf.class, orientation);
	}
	...
	protected de.uni_koblenz.jgralab.impl.ReversedEdgeBaseImpl createReversedEdge() {
		return new ReversedIsTableHeaderOfImpl(this, graph);
	}
	public Expression getAlpha() {
		return (Expression) super.getAlpha();
	}
	public ComprehensionWithTableHeader getOmega() {
		return (ComprehensionWithTableHeader) super.getOmega();
	}
}
