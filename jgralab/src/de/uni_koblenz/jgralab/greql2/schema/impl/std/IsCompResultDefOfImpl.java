...
import de.uni_koblenz.jgralab.greql2.schema.impl.std.ReversedIsCompResultDefOfImpl;
...
public class IsCompResultDefOfImpl extends EdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.Greql2Aggregation, de.uni_koblenz.jgralab.greql2.schema.IsCompResultDefOf {

	protected org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions;

	public IsCompResultDefOfImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsCompResultDefOf.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsCompResultDefOf.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("sourcePositions")) return (T) get_sourcePositions();
		throw new NoSuchAttributeException("IsCompResultDefOf doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsCompResultDefOf getNextIsCompResultDefOfInGraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsCompResultDefOf)getNextEdge(de.uni_koblenz.jgralab.greql2.schema.IsCompResultDefOf.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsCompResultDefOf getNextIsCompResultDefOfIncidence() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsCompResultDefOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsCompResultDefOf.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsCompResultDefOf getNextIsCompResultDefOfIncidence(EdgeDirection orientation) {
		return (de.uni_koblenz.jgralab.greql2.schema.IsCompResultDefOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsCompResultDefOf.class, orientation);
	}
	...
	protected de.uni_koblenz.jgralab.impl.ReversedEdgeBaseImpl createReversedEdge() {
		return new ReversedIsCompResultDefOfImpl(this, graph);
	}
	public Expression getAlpha() {
		return (Expression) super.getAlpha();
	}
	public Comprehension getOmega() {
		return (Comprehension) super.getOmega();
	}
}
