...
import de.uni_koblenz.jgralab.greql2.schema.impl.std.ReversedIsTypeRestrOfExpressionImpl;
...
public class IsTypeRestrOfExpressionImpl extends EdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.Greql2Aggregation, de.uni_koblenz.jgralab.greql2.schema.IsTypeRestrOfExpression {

	protected org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions;

	public IsTypeRestrOfExpressionImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsTypeRestrOfExpression.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsTypeRestrOfExpression.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("sourcePositions")) return (T) get_sourcePositions();
		throw new NoSuchAttributeException("IsTypeRestrOfExpression doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsTypeRestrOfExpression getNextIsTypeRestrOfExpressionInGraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsTypeRestrOfExpression)getNextEdge(de.uni_koblenz.jgralab.greql2.schema.IsTypeRestrOfExpression.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsTypeRestrOfExpression getNextIsTypeRestrOfExpressionIncidence() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsTypeRestrOfExpression)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsTypeRestrOfExpression.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsTypeRestrOfExpression getNextIsTypeRestrOfExpressionIncidence(EdgeDirection orientation) {
		return (de.uni_koblenz.jgralab.greql2.schema.IsTypeRestrOfExpression)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsTypeRestrOfExpression.class, orientation);
	}
	...
	protected de.uni_koblenz.jgralab.impl.ReversedEdgeBaseImpl createReversedEdge() {
		return new ReversedIsTypeRestrOfExpressionImpl(this, graph);
	}
