...
import de.uni_koblenz.jgralab.greql2.schema.impl.std.ReversedIsKeyExprOfConstructionImpl;
...
public class IsKeyExprOfConstructionImpl extends EdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.Greql2Aggregation, de.uni_koblenz.jgralab.greql2.schema.IsKeyExprOfConstruction {

	protected org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions;

	public IsKeyExprOfConstructionImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsKeyExprOfConstruction.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsKeyExprOfConstruction.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("sourcePositions")) return (T) get_sourcePositions();
		throw new NoSuchAttributeException("IsKeyExprOfConstruction doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsKeyExprOfConstruction getNextIsKeyExprOfConstructionInGraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsKeyExprOfConstruction)getNextEdge(de.uni_koblenz.jgralab.greql2.schema.IsKeyExprOfConstruction.class);
	}
	...
	protected de.uni_koblenz.jgralab.impl.ReversedEdgeBaseImpl createReversedEdge() {
		return new ReversedIsKeyExprOfConstructionImpl(this, graph);
	}
