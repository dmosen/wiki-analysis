...
import de.uni_koblenz.jgralab.greql2.schema.impl.std.ReversedIsFalseExprOfImpl;
...
public class IsFalseExprOfImpl extends EdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.Greql2Aggregation, de.uni_koblenz.jgralab.greql2.schema.IsFalseExprOf {

	protected org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions;

	public IsFalseExprOfImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsFalseExprOf.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsFalseExprOf.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("sourcePositions")) return (T) get_sourcePositions();
		throw new NoSuchAttributeException("IsFalseExprOf doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsFalseExprOf getNextIsFalseExprOfInGraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsFalseExprOf)getNextEdge(de.uni_koblenz.jgralab.greql2.schema.IsFalseExprOf.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsFalseExprOf getNextIsFalseExprOfIncidence() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsFalseExprOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsFalseExprOf.class);
	}

	public de.uni_koblenz.jgralab.greql2.schema.IsFalseExprOf getNextIsFalseExprOfIncidence(EdgeDirection orientation) {
		return (de.uni_koblenz.jgralab.greql2.schema.IsFalseExprOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsFalseExprOf.class, orientation);
	}
	...
	protected de.uni_koblenz.jgralab.impl.ReversedEdgeBaseImpl createReversedEdge() {
		return new ReversedIsFalseExprOfImpl(this, graph);
	}
