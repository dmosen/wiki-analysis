...
import de.uni_koblenz.jgralab.greql2.schema.impl.std.ReversedIsBoundExprOfQuantifierImpl;
...
public class IsBoundExprOfQuantifierImpl extends EdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.IsBoundExprOf, de.uni_koblenz.jgralab.greql2.schema.IsBoundExprOfQuantifier {

	protected org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions;

	public IsBoundExprOfQuantifierImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsBoundExprOfQuantifier.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsBoundExprOfQuantifier.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("sourcePositions")) return (T) get_sourcePositions();
		throw new NoSuchAttributeException("IsBoundExprOfQuantifier doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsBoundExprOf getNextIsBoundExprOfInGraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsBoundExprOf)getNextEdge(de.uni_koblenz.jgralab.greql2.schema.IsBoundExprOf.class);
	}

	public de.uni_koblenz.jgralab.greql2.schema.IsBoundExprOfQuantifier getNextIsBoundExprOfQuantifierInGraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsBoundExprOfQuantifier)getNextEdge(de.uni_koblenz.jgralab.greql2.schema.IsBoundExprOfQuantifier.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsBoundExprOfQuantifier getNextIsBoundExprOfQuantifierIncidence() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsBoundExprOfQuantifier)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsBoundExprOfQuantifier.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsBoundExprOfQuantifier getNextIsBoundExprOfQuantifierIncidence(EdgeDirection orientation) {
		return (de.uni_koblenz.jgralab.greql2.schema.IsBoundExprOfQuantifier)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsBoundExprOfQuantifier.class, orientation);
	}
	...
	protected de.uni_koblenz.jgralab.impl.ReversedEdgeBaseImpl createReversedEdge() {
		return new ReversedIsBoundExprOfQuantifierImpl(this, graph);
	}
