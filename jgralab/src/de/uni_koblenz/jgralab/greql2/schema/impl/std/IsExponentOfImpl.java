...
import de.uni_koblenz.jgralab.greql2.schema.impl.std.ReversedIsExponentOfImpl;
 ...
 * FromRoleName : exponent
 * ToVertexClass: ExponentiatedPathDescription
 * ToRoleName : 
 */

public class IsExponentOfImpl extends EdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.Greql2Aggregation, de.uni_koblenz.jgralab.greql2.schema.IsExponentOf {

	protected org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions;

	public IsExponentOfImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsExponentOf.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsExponentOf.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("sourcePositions")) return (T) get_sourcePositions();
		throw new NoSuchAttributeException("IsExponentOf doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsExponentOf getNextIsExponentOfInGraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsExponentOf)getNextEdge(de.uni_koblenz.jgralab.greql2.schema.IsExponentOf.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsExponentOf getNextIsExponentOfIncidence() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsExponentOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsExponentOf.class);
	}

	public de.uni_koblenz.jgralab.greql2.schema.IsExponentOf getNextIsExponentOfIncidence(EdgeDirection orientation) {
		return (de.uni_koblenz.jgralab.greql2.schema.IsExponentOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsExponentOf.class, orientation);
	}
	...
	protected de.uni_koblenz.jgralab.impl.ReversedEdgeBaseImpl createReversedEdge() {
		return new ReversedIsExponentOfImpl(this, graph);
	}
	public IntLiteral getAlpha() {
		return (IntLiteral) super.getAlpha();
	}
