...
import de.uni_koblenz.jgralab.greql2.schema.impl.std.ReversedIsConstraintOfImpl;
...
public class IsConstraintOfImpl extends EdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.Greql2Aggregation, de.uni_koblenz.jgralab.greql2.schema.IsConstraintOf {

	protected org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions;

	public IsConstraintOfImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsConstraintOf.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsConstraintOf.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("sourcePositions")) return (T) get_sourcePositions();
		throw new NoSuchAttributeException("IsConstraintOf doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsConstraintOf getNextIsConstraintOfInGraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsConstraintOf)getNextEdge(de.uni_koblenz.jgralab.greql2.schema.IsConstraintOf.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsConstraintOf getNextIsConstraintOfIncidence() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsConstraintOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsConstraintOf.class);
	}

	public de.uni_koblenz.jgralab.greql2.schema.IsConstraintOf getNextIsConstraintOfIncidence(EdgeDirection orientation) {
		return (de.uni_koblenz.jgralab.greql2.schema.IsConstraintOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsConstraintOf.class, orientation);
	}
	...
	protected de.uni_koblenz.jgralab.impl.ReversedEdgeBaseImpl createReversedEdge() {
		return new ReversedIsConstraintOfImpl(this, graph);
	}
