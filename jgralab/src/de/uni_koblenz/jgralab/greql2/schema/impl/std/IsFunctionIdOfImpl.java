...
import de.uni_koblenz.jgralab.greql2.schema.impl.std.ReversedIsFunctionIdOfImpl;
 ...
 * FromRoleName : functionId
 * ToVertexClass: FunctionApplication
 * ToRoleName : 
 */

public class IsFunctionIdOfImpl extends EdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.Greql2Aggregation, de.uni_koblenz.jgralab.greql2.schema.IsFunctionIdOf {

	protected org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions;

	public IsFunctionIdOfImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsFunctionIdOf.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsFunctionIdOf.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("sourcePositions")) return (T) get_sourcePositions();
		throw new NoSuchAttributeException("IsFunctionIdOf doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsFunctionIdOf getNextIsFunctionIdOfInGraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsFunctionIdOf)getNextEdge(de.uni_koblenz.jgralab.greql2.schema.IsFunctionIdOf.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsFunctionIdOf getNextIsFunctionIdOfIncidence() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsFunctionIdOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsFunctionIdOf.class);
	}

	public de.uni_koblenz.jgralab.greql2.schema.IsFunctionIdOf getNextIsFunctionIdOfIncidence(EdgeDirection orientation) {
		return (de.uni_koblenz.jgralab.greql2.schema.IsFunctionIdOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsFunctionIdOf.class, orientation);
	}
	...
	protected de.uni_koblenz.jgralab.impl.ReversedEdgeBaseImpl createReversedEdge() {
		return new ReversedIsFunctionIdOfImpl(this, graph);
	}
	public FunctionId getAlpha() {
		return (FunctionId) super.getAlpha();
	}
