...
import de.uni_koblenz.jgralab.greql2.schema.impl.std.ReversedIsTargetExprOfImpl;
...
public class IsTargetExprOfImpl extends EdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.Greql2Aggregation, de.uni_koblenz.jgralab.greql2.schema.IsTargetExprOf {

	protected org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions;

	public IsTargetExprOfImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsTargetExprOf.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsTargetExprOf.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("sourcePositions")) return (T) get_sourcePositions();
		throw new NoSuchAttributeException("IsTargetExprOf doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsTargetExprOf getNextIsTargetExprOfInGraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsTargetExprOf)getNextEdge(de.uni_koblenz.jgralab.greql2.schema.IsTargetExprOf.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsTargetExprOf getNextIsTargetExprOfIncidence() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsTargetExprOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsTargetExprOf.class);
	}

	public de.uni_koblenz.jgralab.greql2.schema.IsTargetExprOf getNextIsTargetExprOfIncidence(EdgeDirection orientation) {
		return (de.uni_koblenz.jgralab.greql2.schema.IsTargetExprOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsTargetExprOf.class, orientation);
	}
	...
	protected de.uni_koblenz.jgralab.impl.ReversedEdgeBaseImpl createReversedEdge() {
		return new ReversedIsTargetExprOfImpl(this, graph);
	}
