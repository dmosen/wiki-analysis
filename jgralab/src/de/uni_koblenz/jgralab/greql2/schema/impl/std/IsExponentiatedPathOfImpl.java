...
import de.uni_koblenz.jgralab.greql2.schema.impl.std.ReversedIsExponentiatedPathOfImpl;
 ...
 * FromRoleName : exponentiatedPath
 * ToVertexClass: ExponentiatedPathDescription
 * ToRoleName : 
 */

public class IsExponentiatedPathOfImpl extends EdgeImpl implements de.uni_koblenz.jgralab.greql2.schema.IsExponentiatedPathOf, de.uni_koblenz.jgralab.greql2.schema.IsPathDescriptionOf {

	protected org.pcollections.PVector<de.uni_koblenz.jgralab.greql2.schema.SourcePosition> _sourcePositions;

	public IsExponentiatedPathOfImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsExponentiatedPathOf.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralab.greql2.schema.IsExponentiatedPathOf.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("sourcePositions")) return (T) get_sourcePositions();
		throw new NoSuchAttributeException("IsExponentiatedPathOf doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsExponentiatedPathOf getNextIsExponentiatedPathOfInGraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsExponentiatedPathOf)getNextEdge(de.uni_koblenz.jgralab.greql2.schema.IsExponentiatedPathOf.class);
	}

	public de.uni_koblenz.jgralab.greql2.schema.IsPathDescriptionOf getNextIsPathDescriptionOfInGraph() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsPathDescriptionOf)getNextEdge(de.uni_koblenz.jgralab.greql2.schema.IsPathDescriptionOf.class);
	}
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsExponentiatedPathOf getNextIsExponentiatedPathOfIncidence() {
		return (de.uni_koblenz.jgralab.greql2.schema.IsExponentiatedPathOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsExponentiatedPathOf.class);
	}

	public de.uni_koblenz.jgralab.greql2.schema.IsExponentiatedPathOf getNextIsExponentiatedPathOfIncidence(EdgeDirection orientation) {
		return (de.uni_koblenz.jgralab.greql2.schema.IsExponentiatedPathOf)getNextIncidence(de.uni_koblenz.jgralab.greql2.schema.IsExponentiatedPathOf.class, orientation);
	}
	...
	protected de.uni_koblenz.jgralab.impl.ReversedEdgeBaseImpl createReversedEdge() {
		return new ReversedIsExponentiatedPathOfImpl(this, graph);
	}
	public PathDescription getAlpha() {
		return (PathDescription) super.getAlpha();
	}
	public ExponentiatedPathDescription getOmega() {
		return (ExponentiatedPathDescription) super.getOmega();
	}
}
