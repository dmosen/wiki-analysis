...
public interface OptionalPathDescription extends de.uni_koblenz.jgralab.greql2.schema.PathDescription {

	public static final de.uni_koblenz.jgralab.schema.VertexClass VC = de.uni_koblenz.jgralab.greql2.schema.Greql2Schema.instance().vc_OptionalPathDescription;
	...
	/**
	 * @return the next de.uni_koblenz.jgralab.greql2.schema.OptionalPathDescription vertex in the global vertex sequence
	 */
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsOptionalPathOf getFirstIsOptionalPathOfIncidence(EdgeDirection orientation);
		...
		/**
		 * adds the given vertex as <code>optionalPath</code> to this vertex, i.e. creates an
		 * <code>de.uni_koblenz.jgralab.greql2.schema.IsOptionalPathOf</code> edge from this vertex to the given 
		 * one and returns the created edge.
		 * @return  a newly created edge of type <code>de.uni_koblenz.jgralab.greql2.schema.IsOptionalPathOf</code>
		 *          between this vertex and the given one.
		 */
		...
		/**
		 * removes all optionalPath adjacences to all vertices by 
		 * deleting the <code>de.uni_koblenz.jgralab.greql2.schema.IsOptionalPathOf</code> edges of this vertex to 
		 * all other ones, but doesn't delete those vertices.
		 *
		 * @return the adjacent vertices prior to removal of incidences
		 */
		...
		/**
		 * removes the given vertex as <code>optionalPath</code> from this vertex, i.e. 
		 * deletes the <code>de.uni_koblenz.jgralab.greql2.schema.IsOptionalPathOf</code> edge connections of this vertex with 
		 * the given one.
		 */
		public boolean remove_optionalPath(de.uni_koblenz.jgralab.greql2.schema.PathDescription vertex);
		/**
		 * @return the vertex to this one with the rolename 'optionalPath' 
		 *         (connected with a <code>de.uni_koblenz.jgralab.greql2.schema.IsOptionalPathOf</code> edge), or null if no such vertex exists
		 */
