...
public interface ListConstruction extends de.uni_koblenz.jgralab.greql2.schema.ValueConstruction {

	public static final de.uni_koblenz.jgralab.schema.VertexClass VC = de.uni_koblenz.jgralab.greql2.schema.Greql2Schema.instance().vc_ListConstruction;
