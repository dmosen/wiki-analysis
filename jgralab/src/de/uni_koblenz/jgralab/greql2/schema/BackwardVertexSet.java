...
public interface BackwardVertexSet extends de.uni_koblenz.jgralab.greql2.schema.PathExpression {

	public static final de.uni_koblenz.jgralab.schema.VertexClass VC = de.uni_koblenz.jgralab.greql2.schema.Greql2Schema.instance().vc_BackwardVertexSet;

	/**
	 * @return the next de.uni_koblenz.jgralab.greql2.schema.BackwardVertexSet vertex in the global vertex sequence
	 */
