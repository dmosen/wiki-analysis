...
public interface ThisVertex extends de.uni_koblenz.jgralab.greql2.schema.ThisLiteral {

	public static final de.uni_koblenz.jgralab.schema.VertexClass VC = de.uni_koblenz.jgralab.greql2.schema.Greql2Schema.instance().vc_ThisVertex;
	...
	/**
	 * @return the next de.uni_koblenz.jgralab.greql2.schema.ThisLiteral vertex in the global vertex sequence
	 */
	public de.uni_koblenz.jgralab.greql2.schema.ThisLiteral getNextThisLiteral();

	/**
	 * @return the next de.uni_koblenz.jgralab.greql2.schema.ThisVertex vertex in the global vertex sequence
	 */
