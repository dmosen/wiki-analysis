...
public interface TypeOrRoleId extends de.uni_koblenz.jgralab.greql2.schema.Identifier {

	public static final de.uni_koblenz.jgralab.schema.VertexClass VC = de.uni_koblenz.jgralab.greql2.schema.Greql2Schema.instance().vc_TypeOrRoleId;
