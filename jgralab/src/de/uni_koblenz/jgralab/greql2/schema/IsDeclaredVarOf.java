...
public interface IsDeclaredVarOf extends de.uni_koblenz.jgralab.greql2.schema.Greql2Aggregation {

	public static final de.uni_koblenz.jgralab.schema.EdgeClass EC = de.uni_koblenz.jgralab.greql2.schema.Greql2Schema.instance().ec_IsDeclaredVarOf;
	...
	/**
	 * @return the next de.uni_koblenz.jgralab.greql2.schema.IsDeclaredVarOf edge in the global edge sequence
	 */
	...
	/**
	 * @return the next edge of class de.uni_koblenz.jgralab.greql2.schema.IsDeclaredVarOf at the "this" vertex
	 */
