...
public interface RecordConstruction extends de.uni_koblenz.jgralab.greql2.schema.ValueConstruction {

	public static final de.uni_koblenz.jgralab.schema.VertexClass VC = de.uni_koblenz.jgralab.greql2.schema.Greql2Schema.instance().vc_RecordConstruction;
	...
	/**
	 * @return the next de.uni_koblenz.jgralab.greql2.schema.RecordConstruction vertex in the global vertex sequence
	 */
	...
	public de.uni_koblenz.jgralab.greql2.schema.IsRecordElementOf getFirstIsRecordElementOfIncidence(EdgeDirection orientation);
		...
		/**
		 * adds the given vertex as <code>recordElement</code> to this vertex, i.e. creates an
		 * <code>de.uni_koblenz.jgralab.greql2.schema.IsRecordElementOf</code> edge from this vertex to the given 
		 * one and returns the created edge.
		 * @return  a newly created edge of type <code>de.uni_koblenz.jgralab.greql2.schema.IsRecordElementOf</code>
		 *          between this vertex and the given one.
		 */
		...
		/**
		 * removes all recordElement adjacences to all vertices by 
		 * deleting the <code>de.uni_koblenz.jgralab.greql2.schema.IsRecordElementOf</code> edges of this vertex to 
		 * all other ones, but doesn't delete those vertices.
		 *
		 * @return the adjacent vertices prior to removal of incidences
		 */
		...
		/**
		 * removes the given vertex as <code>recordElement</code> from this vertex, i.e. 
		 * deletes the <code>de.uni_koblenz.jgralab.greql2.schema.IsRecordElementOf</code> edge connections of this vertex with 
		 * the given one.
		 */
		public boolean remove_recordElement(de.uni_koblenz.jgralab.greql2.schema.RecordElement vertex);
		/**
		 * @return an Iterable of all vertices adjacent to this one with the rolename 'recordElement'
		 *         (connected with a <code>de.uni_koblenz.jgralab.greql2.schema.IsRecordElementOf</code> edge).
		 */
