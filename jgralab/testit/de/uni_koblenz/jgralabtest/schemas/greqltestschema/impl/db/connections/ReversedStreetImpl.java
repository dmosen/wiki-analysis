...
public class ReversedStreetImpl extends ReversedEdgeImpl implements de.uni_koblenz.jgralabtest.schemas.greqltestschema.connections.Street, de.uni_koblenz.jgralabtest.schemas.greqltestschema.connections.Way {
	...
	public double get_length() {
		return ((de.uni_koblenz.jgralabtest.schemas.greqltestschema.connections.Street)normalEdge).get_length();
	}

	public void set_length(double _length) {
		((de.uni_koblenz.jgralabtest.schemas.greqltestschema.connections.Street)normalEdge).set_length(_length);
	}

	public java.lang.String get_name() {
		return ((de.uni_koblenz.jgralabtest.schemas.greqltestschema.connections.Street)normalEdge).get_name();
	}

	public void set_name(java.lang.String _name) {
		((de.uni_koblenz.jgralabtest.schemas.greqltestschema.connections.Street)normalEdge).set_name(_name);
	}

	public boolean is_oneway() {
		return ((de.uni_koblenz.jgralabtest.schemas.greqltestschema.connections.Street)normalEdge).is_oneway();
	}

	public void set_oneway(boolean _oneway) {
		((de.uni_koblenz.jgralabtest.schemas.greqltestschema.connections.Street)normalEdge).set_oneway(_oneway);
	}
