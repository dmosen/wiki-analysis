...
package de.uni_koblenz.jgralabtest.schemas.greqltestschema.impl.trans.junctions;
...
public class RoundaboutImpl extends VertexImpl implements de.uni_koblenz.jgralabtest.schemas.greqltestschema.junctions.Crossroad, de.uni_koblenz.jgralabtest.schemas.greqltestschema.junctions.Roundabout {

	public RoundaboutImpl(int id, de.uni_koblenz.jgralab.Graph g) {
		super(id, g);
	}

	@Override
	public final de.uni_koblenz.jgralab.schema.VertexClass getAttributedElementClass() {
		return de.uni_koblenz.jgralabtest.schemas.greqltestschema.junctions.Roundabout.VC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Vertex> getSchemaClass() {
		return de.uni_koblenz.jgralabtest.schemas.greqltestschema.junctions.Roundabout.class;
	}

	public <T> T getAttribute(String attributeName) {
		throw new NoSuchAttributeException("junctions.Roundabout doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralabtest.schemas.greqltestschema.junctions.Roundabout getNextRoundabout() {
		return (de.uni_koblenz.jgralabtest.schemas.greqltestschema.junctions.Roundabout)getNextVertex(de.uni_koblenz.jgralabtest.schemas.greqltestschema.junctions.Roundabout.class);
	}
	...
	public de.uni_koblenz.jgralabtest.schemas.greqltestschema.connections.Way getFirstWayIncidence(EdgeDirection orientation) {
		...
		public de.uni_koblenz.jgralabtest.schemas.greqltestschema.connections.Connection add_src(de.uni_koblenz.jgralabtest.schemas.greqltestschema.junctions.Junction vertex) {
			return ((de.uni_koblenz.jgralabtest.schemas.greqltestschema.RouteMap)getGraph()).createEdge(de.uni_koblenz.jgralabtest.schemas.greqltestschema.connections.Connection.EC, (de.uni_koblenz.jgralabtest.schemas.greqltestschema.junctions.Junction) vertex, (de.uni_koblenz.jgralabtest.schemas.greqltestschema.junctions.Roundabout) this);
		}
		@Override
		...
		public de.uni_koblenz.jgralabtest.schemas.greqltestschema.localities.ContainsCrossroad add_locality(de.uni_koblenz.jgralabtest.schemas.greqltestschema.localities.Locality vertex) {
			return ((de.uni_koblenz.jgralabtest.schemas.greqltestschema.RouteMap)getGraph()).createEdge(de.uni_koblenz.jgralabtest.schemas.greqltestschema.localities.ContainsCrossroad.EC, (de.uni_koblenz.jgralabtest.schemas.greqltestschema.localities.Locality) vertex, (de.uni_koblenz.jgralabtest.schemas.greqltestschema.junctions.Roundabout) this);
		}
		@Override
		...
		public de.uni_koblenz.jgralabtest.schemas.greqltestschema.connections.Connection add_dst(de.uni_koblenz.jgralabtest.schemas.greqltestschema.junctions.Junction vertex) {
			return ((de.uni_koblenz.jgralabtest.schemas.greqltestschema.RouteMap)getGraph()).createEdge(de.uni_koblenz.jgralabtest.schemas.greqltestschema.connections.Connection.EC, (de.uni_koblenz.jgralabtest.schemas.greqltestschema.junctions.Roundabout) this, (de.uni_koblenz.jgralabtest.schemas.greqltestschema.junctions.Junction) vertex);
		}
		@Override
