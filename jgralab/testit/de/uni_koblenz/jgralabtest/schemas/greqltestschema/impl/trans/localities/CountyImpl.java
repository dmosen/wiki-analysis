...
public class CountyImpl extends VertexImpl implements de.uni_koblenz.jgralabtest.schemas.greqltestschema.NamedElement, de.uni_koblenz.jgralabtest.schemas.greqltestschema.localities.County {
	...
	protected de.uni_koblenz.jgralab.impl.trans.VersionedReferenceImpl<org.pcollections.PMap<de.uni_koblenz.jgralabtest.schemas.greqltestschema.localities.CountyTags, java.lang.Double>> _tags;
	...
	public org.pcollections.PMap<de.uni_koblenz.jgralabtest.schemas.greqltestschema.localities.CountyTags, java.lang.Double> get_tags() {
		if (!isValid())
			throw new de.uni_koblenz.jgralab.GraphException("Cannot access attribute 'tags', because " + this + " isn't valid in current transaction.");
		if (_tags == null)
			return null;
		org.pcollections.PMap<de.uni_koblenz.jgralabtest.schemas.greqltestschema.localities.CountyTags, java.lang.Double> value = _tags.getValidValue(graph.getCurrentTransaction());
		return (value == null) ? null : value;
	}
	...
	public void set_tags(org.pcollections.PMap<de.uni_koblenz.jgralabtest.schemas.greqltestschema.localities.CountyTags, java.lang.Double> _tags) {
		if (!isValid())
			throw new de.uni_koblenz.jgralab.GraphException("Cannot access attribute 'tags', because " + this + " isn't valid in current transaction.");
		if (graph.isLoading()) {
			this._tags = new de.uni_koblenz.jgralab.impl.trans.VersionedReferenceImpl<org.pcollections.PMap<de.uni_koblenz.jgralabtest.schemas.greqltestschema.localities.CountyTags, java.lang.Double>>(this, _tags, "tags");
		}
		if (this._tags == null) {
			this._tags = new de.uni_koblenz.jgralab.impl.trans.VersionedReferenceImpl<org.pcollections.PMap<de.uni_koblenz.jgralabtest.schemas.greqltestschema.localities.CountyTags, java.lang.Double>>(this, null, "tags");
		}
		this._tags.setValidValue((org.pcollections.PMap<de.uni_koblenz.jgralabtest.schemas.greqltestschema.localities.CountyTags, java.lang.Double>) _tags, graph.getCurrentTransaction());
		attributeChanged(this._tags);
		graphModified();
	}
	...
	public void readAttributeValues(GraphIO io) throws GraphIOException {
		...
		set_name(_name);
		org.pcollections.PMap<de.uni_koblenz.jgralabtest.schemas.greqltestschema.localities.CountyTags, java.lang.Double> _tags = null;
		if (io.isNextToken("{")) {
	...
	public void readAttributeValueFromString(String attributeName, String value) throws GraphIOException {
		...
		if (attributeName.equals("tags")) {
			GraphIO io = GraphIO.createStringReader(value, getSchema());
			org.pcollections.PMap<de.uni_koblenz.jgralabtest.schemas.greqltestschema.localities.CountyTags, java.lang.Double> tmpVar = null;
			
			if (io.isNextToken("{")) {
				org.pcollections.PMap<de.uni_koblenz.jgralabtest.schemas.greqltestschema.localities.CountyTags, java.lang.Double> $tmpVar = de.uni_koblenz.jgralab.JGraLab.map();
				io.match("{");
				while (!io.isNextToken("}")) {
					de.uni_koblenz.jgralabtest.schemas.greqltestschema.localities.CountyTags tmpVarKey;
						double tmpVarValue;
					tmpVarKey = de.uni_koblenz.jgralabtest.schemas.greqltestschema.localities.CountyTags.valueOfPermitNull(io.matchEnumConstant());
					io.match("-");
					tmpVarValue = io.matchDouble();
	...
	public void writeAttributeValues(GraphIO io) throws GraphIOException, IOException {
		...
		if (get_tags() != null) {
			...
			io.write("{");
			io.noSpace();
			for (de.uni_koblenz.jgralabtest.schemas.greqltestschema.localities.CountyTags key: get_tags().keySet()) {
				double value = get_tags().get(key);
				if (key != null) {
