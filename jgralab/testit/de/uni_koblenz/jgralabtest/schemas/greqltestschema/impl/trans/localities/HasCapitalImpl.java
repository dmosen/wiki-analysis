...
import de.uni_koblenz.jgralabtest.schemas.greqltestschema.impl.trans.localities.ReversedHasCapitalImpl;
...
public class HasCapitalImpl extends EdgeImpl implements de.uni_koblenz.jgralab.Edge, de.uni_koblenz.jgralabtest.schemas.greqltestschema.localities.HasCapital {

	public HasCapitalImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
		super(id, g, alpha, omega);
	}

	@Override
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralabtest.schemas.greqltestschema.localities.HasCapital.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralabtest.schemas.greqltestschema.localities.HasCapital.class;
	}

	public <T> T getAttribute(String attributeName) {
		throw new NoSuchAttributeException("localities.HasCapital doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralabtest.schemas.greqltestschema.localities.HasCapital getNextHasCapitalInGraph() {
		return (de.uni_koblenz.jgralabtest.schemas.greqltestschema.localities.HasCapital)getNextEdge(de.uni_koblenz.jgralabtest.schemas.greqltestschema.localities.HasCapital.class);
	}
	...
	protected de.uni_koblenz.jgralab.impl.ReversedEdgeBaseImpl createReversedEdge() {
		return new ReversedHasCapitalImpl(this, graph);
	}
