...
public class WeightedGraphImpl extends GraphImpl implements de.uni_koblenz.jgralab.Graph, de.uni_koblenz.jgralabtest.schemas.algolib.weighted.WeightedGraph {
	...
	**/
	public WeightedGraphImpl(java.lang.String id, GraphDatabase graphDatabase) {
		super(id, de.uni_koblenz.jgralabtest.schemas.algolib.weighted.WeightedGraph.GC, graphDatabase);
	 ...
	 * For instantiating a Graph, use a GraphFactory
	**/
	public WeightedGraphImpl(java.lang.String id, int vMax, int eMax, GraphDatabase graphDatabase) {
		super(id, vMax, eMax, de.uni_koblenz.jgralabtest.schemas.algolib.weighted.WeightedGraph.GC, graphDatabase);
		initializeAttributesWithDefaultValues();
	}
