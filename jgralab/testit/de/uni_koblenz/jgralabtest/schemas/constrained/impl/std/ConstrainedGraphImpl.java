...
public class ConstrainedGraphImpl extends GraphImpl implements de.uni_koblenz.jgralabtest.schemas.constrained.ConstrainedGraph, de.uni_koblenz.jgralab.Graph {
	...
	**/
	 ...
	 * For instantiating a Graph, use the Schema and a GraphFactory
	**/
	public ConstrainedGraphImpl(int vMax, int eMax) {
		this(null, vMax, eMax);
	}
	 ...
	 * For instantiating a Graph, use the Schema and a GraphFactory
	**/
	public ConstrainedGraphImpl(java.lang.String id, int vMax, int eMax) {
		super(id, de.uni_koblenz.jgralabtest.schemas.constrained.ConstrainedGraph.GC, vMax, eMax);
	 ...
	 * For instantiating a Graph, use the Schema and a GraphFactory
	**/
	public ConstrainedGraphImpl(java.lang.String id) {
		super(id, de.uni_koblenz.jgralabtest.schemas.constrained.ConstrainedGraph.GC);
		initializeAttributesWithDefaultValues();
	}
