...
public class MotorwayMapImpl extends GraphImpl implements de.uni_koblenz.jgralab.Graph, de.uni_koblenz.jgralabtest.schemas.motorwaymap.MotorwayMap {
	...
	protected de.uni_koblenz.jgralab.impl.trans.VersionedReferenceImpl<java.lang.String> _test;
	...
	**/
	...
	public java.lang.String get_test() {
		if (_test == null)
			return null;
		java.lang.String value = _test.getValidValue(this.getCurrentTransaction());
		return (value == null) ? null : value;
	}

	public void set_test(java.lang.String _test) {
		if (this.isLoading()) {
			this._test = new de.uni_koblenz.jgralab.impl.trans.VersionedReferenceImpl<java.lang.String>(this, _test, "test");
		}
		if (this._test == null) {
			this._test = new de.uni_koblenz.jgralab.impl.trans.VersionedReferenceImpl<java.lang.String>(this, null, "test");
		}
		this._test.setValidValue((java.lang.String) _test, this.getCurrentTransaction());
		attributeChanged(this._test);
		graphModified();
	}

	public void readAttributeValues(GraphIO io) throws GraphIOException {
		java.lang.String _test = io.matchUtfString();
		set_test(_test);
	}
