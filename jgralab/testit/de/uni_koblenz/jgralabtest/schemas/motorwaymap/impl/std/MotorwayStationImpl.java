...
public class MotorwayStationImpl extends VertexImpl implements de.uni_koblenz.jgralabtest.schemas.motorwaymap.MotorwayStation, de.uni_koblenz.jgralabtest.schemas.motorwaymap.StoppingPlace {

	protected java.lang.String _name;

	public MotorwayStationImpl(int id, de.uni_koblenz.jgralab.Graph g) {
		super(id, g);
	}

	@Override
	public final de.uni_koblenz.jgralab.schema.VertexClass getAttributedElementClass() {
		return de.uni_koblenz.jgralabtest.schemas.motorwaymap.MotorwayStation.VC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Vertex> getSchemaClass() {
		return de.uni_koblenz.jgralabtest.schemas.motorwaymap.MotorwayStation.class;
	}

	@SuppressWarnings("unchecked")
	public <T> T getAttribute(String attributeName) {
		if (attributeName.equals("name")) return (T) get_name();
		throw new NoSuchAttributeException("MotorwayStation doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralabtest.schemas.motorwaymap.MotorwayStation getNextMotorwayStation() {
		return (de.uni_koblenz.jgralabtest.schemas.motorwaymap.MotorwayStation)getNextVertex(de.uni_koblenz.jgralabtest.schemas.motorwaymap.MotorwayStation.class);
	}
