...
public class JniTestGraphImpl extends GraphImpl implements de.uni_koblenz.jgralab.Graph, de.uni_koblenz.jgralabtest.schemas.jniclient.JniTestGraph {
	...
	**/
	public JniTestGraphImpl(java.lang.String id, GraphDatabase graphDatabase) {
		super(id, de.uni_koblenz.jgralabtest.schemas.jniclient.JniTestGraph.GC, graphDatabase);
	 ...
	 * For instantiating a Graph, use a GraphFactory
	**/
	public JniTestGraphImpl(java.lang.String id, int vMax, int eMax, GraphDatabase graphDatabase) {
		super(id, vMax, eMax, de.uni_koblenz.jgralabtest.schemas.jniclient.JniTestGraph.GC, graphDatabase);
		initializeAttributesWithDefaultValues();
	}
