...
public class NodeImpl extends VertexImpl implements de.uni_koblenz.jgralabtest.schemas.jniclient.Node, de.uni_koblenz.jgralab.Vertex {
	...
	public void set_b(boolean _b) {
		ecaAttributeChanging("b", this._b, _b);
		Object oldValue = this._b;
		this._b = _b;
		graphModified();
	ecaAttributeChanged("b", oldValue, _b);
	}
	...
	public void set_color(de.uni_koblenz.jgralabtest.schemas.jniclient.Color _color) {
		ecaAttributeChanging("color", this._color, _color);
		Object oldValue = this._color;
		this._color = _color;
		graphModified();
	ecaAttributeChanged("color", oldValue, _color);
	}
	...
	public void set_d(double _d) {
		ecaAttributeChanging("d", this._d, _d);
		Object oldValue = this._d;
		this._d = _d;
		graphModified();
	ecaAttributeChanged("d", oldValue, _d);
	}
	...
	public void set_i(int _i) {
		ecaAttributeChanging("i", this._i, _i);
		Object oldValue = this._i;
		this._i = _i;
		graphModified();
	ecaAttributeChanged("i", oldValue, _i);
	}
	...
	public void set_l(long _l) {
		ecaAttributeChanging("l", this._l, _l);
		Object oldValue = this._l;
		this._l = _l;
		graphModified();
	ecaAttributeChanged("l", oldValue, _l);
	}
	...
	public void set_ld(org.pcollections.PVector<java.lang.Double> _ld) {
		ecaAttributeChanging("ld", this._ld, _ld);
		Object oldValue = this._ld;
		this._ld = _ld;
		graphModified();
	ecaAttributeChanged("ld", oldValue, _ld);
	}
	...
	public void set_li(org.pcollections.PVector<java.lang.Integer> _li) {
		ecaAttributeChanging("li", this._li, _li);
		Object oldValue = this._li;
		this._li = _li;
		graphModified();
	ecaAttributeChanged("li", oldValue, _li);
	}
	...
	public void set_ll(org.pcollections.PVector<java.lang.Long> _ll) {
		ecaAttributeChanging("ll", this._ll, _ll);
		Object oldValue = this._ll;
		this._ll = _ll;
		graphModified();
	ecaAttributeChanged("ll", oldValue, _ll);
	}
	...
	public void set_ls(org.pcollections.PVector<java.lang.String> _ls) {
		ecaAttributeChanging("ls", this._ls, _ls);
		Object oldValue = this._ls;
		this._ls = _ls;
		graphModified();
	ecaAttributeChanged("ls", oldValue, _ls);
	}
	...
	public void set_s(java.lang.String _s) {
		ecaAttributeChanging("s", this._s, _s);
		Object oldValue = this._s;
		this._s = _s;
		graphModified();
	ecaAttributeChanged("s", oldValue, _s);
	}
