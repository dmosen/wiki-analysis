...
import de.uni_koblenz.jgralabtest.schemas.record.impl.trans.ReversedLinkImpl;
...
public class LinkImpl extends EdgeImpl implements de.uni_koblenz.jgralab.Edge, de.uni_koblenz.jgralabtest.schemas.record.Link {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralabtest.schemas.record.Link.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralabtest.schemas.record.Link.class;
	}
	...
	public de.uni_koblenz.jgralabtest.schemas.record.Link getNextLinkInGraph() {
		return (de.uni_koblenz.jgralabtest.schemas.record.Link)getNextEdge(de.uni_koblenz.jgralabtest.schemas.record.Link.class);
	}
