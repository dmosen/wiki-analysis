...
public interface Chassis extends de.uni_koblenz.jgralabtest.schemas.gretl.bedsl_pddsl.Element {

	public static final de.uni_koblenz.jgralab.schema.VertexClass VC = de.uni_koblenz.jgralabtest.schemas.gretl.bedsl_pddsl.IntegratedBedslPddslSchema.instance().vc_Chassis;

	/**
	 * @return the next de.uni_koblenz.jgralabtest.schemas.gretl.bedsl_pddsl.Chassis vertex in the global vertex sequence
	 */
	...
	public de.uni_koblenz.jgralabtest.schemas.gretl.bedsl_pddsl.HasConfig getFirstHasConfigIncidence(EdgeDirection orientation);
		 ...
		 * <code>de.uni_koblenz.jgralabtest.schemas.gretl.bedsl_pddsl.HasConfig</code> edge from this vertex to the given 
		 * one and returns the created edge.
		 * @return  a newly created edge of type <code>de.uni_koblenz.jgralabtest.schemas.gretl.bedsl_pddsl.HasConfig</code>
		 *          between this vertex and the given one.
		 */
		 ...
		 * deleting the <code>de.uni_koblenz.jgralabtest.schemas.gretl.bedsl_pddsl.HasConfig</code> edges of this vertex to 
		 * all other ones, but doesn't delete those vertices.
		 *
		 * @return the adjacent vertices prior to removal of incidences
		 */
		 ...
		 * deletes the <code>de.uni_koblenz.jgralabtest.schemas.gretl.bedsl_pddsl.HasConfig</code> edge connections of this vertex with 
		 * the given one.
		 */
		 ...
		 *         (connected with a <code>de.uni_koblenz.jgralabtest.schemas.gretl.bedsl_pddsl.HasConfig</code> edge), or null if no such vertex exists
		 */
