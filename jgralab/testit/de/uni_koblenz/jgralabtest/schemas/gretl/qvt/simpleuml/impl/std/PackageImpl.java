...
public class PackageImpl extends VertexImpl implements de.uni_koblenz.jgralabtest.schemas.gretl.qvt.simpleuml.PackagableElement, de.uni_koblenz.jgralabtest.schemas.gretl.qvt.simpleuml.Package {
	...
	public final de.uni_koblenz.jgralab.schema.VertexClass getAttributedElementClass() {
		return de.uni_koblenz.jgralabtest.schemas.gretl.qvt.simpleuml.Package.VC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Vertex> getSchemaClass() {
		return de.uni_koblenz.jgralabtest.schemas.gretl.qvt.simpleuml.Package.class;
	}
	...
	public <T> T getAttribute(String attributeName) {
		...
		throw new NoSuchAttributeException("Package doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralabtest.schemas.gretl.qvt.simpleuml.Package getNextPackage() {
		return (de.uni_koblenz.jgralabtest.schemas.gretl.qvt.simpleuml.Package)getNextVertex(de.uni_koblenz.jgralabtest.schemas.gretl.qvt.simpleuml.Package.class);
	}
	...
	public de.uni_koblenz.jgralabtest.schemas.gretl.qvt.simpleuml.Contains getFirstContainsIncidence(EdgeDirection orientation) {
		...
		public de.uni_koblenz.jgralabtest.schemas.gretl.qvt.simpleuml.Contains add_element(de.uni_koblenz.jgralabtest.schemas.gretl.qvt.simpleuml.PackagableElement vertex) {
			return ((de.uni_koblenz.jgralabtest.schemas.gretl.qvt.simpleuml.SimpleUMLGraph)getGraph()).createEdge(de.uni_koblenz.jgralabtest.schemas.gretl.qvt.simpleuml.Contains.EC, (de.uni_koblenz.jgralabtest.schemas.gretl.qvt.simpleuml.Package) this, (de.uni_koblenz.jgralabtest.schemas.gretl.qvt.simpleuml.PackagableElement) vertex);
		}
		@Override
		public java.util.List<? extends de.uni_koblenz.jgralabtest.schemas.gretl.qvt.simpleuml.PackagableElement> remove_element() {
			java.util.List<de.uni_koblenz.jgralabtest.schemas.gretl.qvt.simpleuml.PackagableElement> adjacences = new java.util.ArrayList<de.uni_koblenz.jgralabtest.schemas.gretl.qvt.simpleuml.PackagableElement>();
			de.uni_koblenz.jgralabtest.schemas.gretl.qvt.simpleuml.Contains edge = (de.uni_koblenz.jgralabtest.schemas.gretl.qvt.simpleuml.Contains) getFirstIncidence(de.uni_koblenz.jgralabtest.schemas.gretl.qvt.simpleuml.Contains.class, EdgeDirection.OUT);
			while (edge != null) {
				de.uni_koblenz.jgralabtest.schemas.gretl.qvt.simpleuml.Contains next = (de.uni_koblenz.jgralabtest.schemas.gretl.qvt.simpleuml.Contains) edge.getNextIncidence(de.uni_koblenz.jgralabtest.schemas.gretl.qvt.simpleuml.Contains.class, EdgeDirection.OUT);
				adjacences.add((de.uni_koblenz.jgralabtest.schemas.gretl.qvt.simpleuml.PackagableElement) edge.getThat());
				edge.delete();
				edge = next;
			}
			return adjacences;
		...
		public Iterable<? extends de.uni_koblenz.jgralabtest.schemas.gretl.qvt.simpleuml.PackagableElement> get_element() {
			return new de.uni_koblenz.jgralab.impl.NeighbourIterable<de.uni_koblenz.jgralabtest.schemas.gretl.qvt.simpleuml.Contains, de.uni_koblenz.jgralabtest.schemas.gretl.qvt.simpleuml.PackagableElement>(this, de.uni_koblenz.jgralabtest.schemas.gretl.qvt.simpleuml.Contains.class, EdgeDirection.OUT);
		}
