...
public class ClassifierImpl extends VertexImpl implements de.uni_koblenz.jgralabtest.schemas.gretl.qvt.simpleuml.Classifier, de.uni_koblenz.jgralabtest.schemas.gretl.qvt.simpleuml.PackagableElement {

	protected java.lang.String _kind;

	protected java.lang.String _name;

	public ClassifierImpl(int id, de.uni_koblenz.jgralab.Graph g) {
		super(id, g);
	}

	@Override
	public final de.uni_koblenz.jgralab.schema.VertexClass getAttributedElementClass() {
		return de.uni_koblenz.jgralabtest.schemas.gretl.qvt.simpleuml.Classifier.VC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Vertex> getSchemaClass() {
		return de.uni_koblenz.jgralabtest.schemas.gretl.qvt.simpleuml.Classifier.class;
	}
	...
	public <T> T getAttribute(String attributeName) {
		...
		throw new NoSuchAttributeException("Classifier doesn't contain an attribute " + attributeName);
	}
