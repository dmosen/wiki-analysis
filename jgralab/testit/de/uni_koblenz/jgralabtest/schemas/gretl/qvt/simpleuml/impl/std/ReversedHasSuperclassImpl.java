...
public class ReversedHasSuperclassImpl extends ReversedEdgeImpl implements de.uni_koblenz.jgralab.Edge, de.uni_koblenz.jgralabtest.schemas.gretl.qvt.simpleuml.HasSuperclass {

	ReversedHasSuperclassImpl(EdgeImpl e, Graph g) {
		super(e, g);
	}
	...
	public de.uni_koblenz.jgralabtest.schemas.gretl.qvt.simpleuml.HasSuperclass getNextHasSuperclassInGraph() {
		return ((de.uni_koblenz.jgralabtest.schemas.gretl.qvt.simpleuml.HasSuperclass)normalEdge).getNextHasSuperclassInGraph();
	}
