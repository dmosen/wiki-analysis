...
import de.uni_koblenz.jgralabtest.schemas.gretl.varro.impl.std.uml.ReversedHasSubImpl;
...
public class HasSubImpl extends EdgeImpl implements de.uni_koblenz.jgralab.Edge, de.uni_koblenz.jgralabtest.schemas.gretl.varro.uml.HasSub {

	public HasSubImpl(int id, de.uni_koblenz.jgralab.Graph g, Vertex alpha, Vertex omega) {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralabtest.schemas.gretl.varro.uml.HasSub.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralabtest.schemas.gretl.varro.uml.HasSub.class;
	}

	public <T> T getAttribute(String attributeName) {
		throw new NoSuchAttributeException("uml.HasSub doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralabtest.schemas.gretl.varro.uml.HasSub getNextHasSubInGraph() {
		return (de.uni_koblenz.jgralabtest.schemas.gretl.varro.uml.HasSub)getNextEdge(de.uni_koblenz.jgralabtest.schemas.gretl.varro.uml.HasSub.class);
	}
	...
	protected de.uni_koblenz.jgralab.impl.ReversedEdgeBaseImpl createReversedEdge() {
		return new ReversedHasSubImpl(this, graph);
	}
