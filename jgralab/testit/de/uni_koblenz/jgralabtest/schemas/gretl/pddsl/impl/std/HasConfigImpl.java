...
import de.uni_koblenz.jgralabtest.schemas.gretl.pddsl.impl.std.ReversedHasConfigImpl;
...
public class HasConfigImpl extends EdgeImpl implements de.uni_koblenz.jgralab.Edge, de.uni_koblenz.jgralabtest.schemas.gretl.pddsl.HasConfig {
	...
	public final de.uni_koblenz.jgralab.schema.EdgeClass getAttributedElementClass() {
		return de.uni_koblenz.jgralabtest.schemas.gretl.pddsl.HasConfig.EC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Edge> getSchemaClass() {
		return de.uni_koblenz.jgralabtest.schemas.gretl.pddsl.HasConfig.class;
	}
	...
	public de.uni_koblenz.jgralabtest.schemas.gretl.pddsl.HasConfig getNextHasConfigInGraph() {
		return (de.uni_koblenz.jgralabtest.schemas.gretl.pddsl.HasConfig)getNextEdge(de.uni_koblenz.jgralabtest.schemas.gretl.pddsl.HasConfig.class);
	}

	public de.uni_koblenz.jgralabtest.schemas.gretl.pddsl.HasConfig getNextHasConfigIncidence() {
		return (de.uni_koblenz.jgralabtest.schemas.gretl.pddsl.HasConfig)getNextIncidence(de.uni_koblenz.jgralabtest.schemas.gretl.pddsl.HasConfig.class);
	}

	public de.uni_koblenz.jgralabtest.schemas.gretl.pddsl.HasConfig getNextHasConfigIncidence(EdgeDirection orientation) {
		return (de.uni_koblenz.jgralabtest.schemas.gretl.pddsl.HasConfig)getNextIncidence(de.uni_koblenz.jgralabtest.schemas.gretl.pddsl.HasConfig.class, orientation);
	}
