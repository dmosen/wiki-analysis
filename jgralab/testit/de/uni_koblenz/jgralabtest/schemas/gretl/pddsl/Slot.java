...
public interface Slot extends de.uni_koblenz.jgralabtest.schemas.gretl.pddsl.Element {

	public static final de.uni_koblenz.jgralab.schema.VertexClass VC = de.uni_koblenz.jgralabtest.schemas.gretl.pddsl.PddslSchema.instance().vc_Slot;
	...
	/**
	 * @return the next de.uni_koblenz.jgralabtest.schemas.gretl.pddsl.Slot vertex in the global vertex sequence
	 */
	...
	public de.uni_koblenz.jgralabtest.schemas.gretl.pddsl.HasCard getFirstHasCardIncidence(EdgeDirection orientation);
		 ...
		 * <code>de.uni_koblenz.jgralabtest.schemas.gretl.pddsl.HasCard</code> edge from this vertex to the given 
		 * one and returns the created edge.
		 * @return  a newly created edge of type <code>de.uni_koblenz.jgralabtest.schemas.gretl.pddsl.HasCard</code>
		 ...
		 * deleting the <code>de.uni_koblenz.jgralabtest.schemas.gretl.pddsl.HasCard</code> edges of this vertex to 
		 ...
		 * deletes the <code>de.uni_koblenz.jgralabtest.schemas.gretl.pddsl.HasCard</code> edge connections of this vertex with 
		 * the given one.
		 */
		 ...
		 *         (connected with a <code>de.uni_koblenz.jgralabtest.schemas.gretl.pddsl.HasCard</code> edge), or null if no such vertex exists
		 */
