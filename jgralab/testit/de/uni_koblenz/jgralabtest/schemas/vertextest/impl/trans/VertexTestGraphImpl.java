...
public class VertexTestGraphImpl extends GraphImpl implements de.uni_koblenz.jgralab.Graph, de.uni_koblenz.jgralabtest.schemas.vertextest.VertexTestGraph {
	...
	**/
	 ...
	 * For instantiating a Graph, use the Schema and a GraphFactory
	**/
	public VertexTestGraphImpl(int vMax, int eMax) {
		this(null, vMax, eMax);
	}
	 ...
	 * For instantiating a Graph, use the Schema and a GraphFactory
	**/
	public VertexTestGraphImpl(java.lang.String id, int vMax, int eMax) {
		super(id, de.uni_koblenz.jgralabtest.schemas.vertextest.VertexTestGraph.GC, vMax, eMax);
	 ...
	 * For instantiating a Graph, use the Schema and a GraphFactory
	**/
	public VertexTestGraphImpl(java.lang.String id) {
		super(id, de.uni_koblenz.jgralabtest.schemas.vertextest.VertexTestGraph.GC);
		initializeAttributesWithDefaultValues();
	}
