...
public class D2Impl extends VertexImpl implements de.uni_koblenz.jgralabtest.schemas.vertextest.D, de.uni_koblenz.jgralabtest.schemas.vertextest.D2 {

	public D2Impl(int id, de.uni_koblenz.jgralab.Graph g) {
		super(id, g);
	}

	@Override
	public final de.uni_koblenz.jgralab.schema.VertexClass getAttributedElementClass() {
		return de.uni_koblenz.jgralabtest.schemas.vertextest.D2.VC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Vertex> getSchemaClass() {
		return de.uni_koblenz.jgralabtest.schemas.vertextest.D2.class;
	}

	public <T> T getAttribute(String attributeName) {
		throw new NoSuchAttributeException("D2 doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralabtest.schemas.vertextest.D2 getNextD2() {
		return (de.uni_koblenz.jgralabtest.schemas.vertextest.D2)getNextVertex(de.uni_koblenz.jgralabtest.schemas.vertextest.D2.class);
	}
	...
	public de.uni_koblenz.jgralabtest.schemas.vertextest.J getFirstJIncidence(EdgeDirection orientation) {
		...
		public de.uni_koblenz.jgralabtest.schemas.vertextest.H add_sourceH(de.uni_koblenz.jgralabtest.schemas.vertextest.A vertex) {
			return ((de.uni_koblenz.jgralabtest.schemas.vertextest.VertexTestGraph)getGraph()).createEdge(de.uni_koblenz.jgralabtest.schemas.vertextest.H.EC, (de.uni_koblenz.jgralabtest.schemas.vertextest.A) vertex, (de.uni_koblenz.jgralabtest.schemas.vertextest.D2) this);
		}
		@Override
		...
		public de.uni_koblenz.jgralabtest.schemas.vertextest.F add_sourceF(de.uni_koblenz.jgralabtest.schemas.vertextest.C vertex) {
			return ((de.uni_koblenz.jgralabtest.schemas.vertextest.VertexTestGraph)getGraph()).createEdge(de.uni_koblenz.jgralabtest.schemas.vertextest.F.EC, (de.uni_koblenz.jgralabtest.schemas.vertextest.C) vertex, (de.uni_koblenz.jgralabtest.schemas.vertextest.D2) this);
		}
		@Override
		...
		public de.uni_koblenz.jgralabtest.schemas.vertextest.K add_sourceK(de.uni_koblenz.jgralabtest.schemas.vertextest.A vertex) {
			return ((de.uni_koblenz.jgralabtest.schemas.vertextest.VertexTestGraph)getGraph()).createEdge(de.uni_koblenz.jgralabtest.schemas.vertextest.K.EC, (de.uni_koblenz.jgralabtest.schemas.vertextest.A) vertex, (de.uni_koblenz.jgralabtest.schemas.vertextest.D2) this);
		}
		@Override
		...
		public de.uni_koblenz.jgralabtest.schemas.vertextest.J add_sourceJ(de.uni_koblenz.jgralabtest.schemas.vertextest.C2 vertex) {
			return ((de.uni_koblenz.jgralabtest.schemas.vertextest.VertexTestGraph)getGraph()).createEdge(de.uni_koblenz.jgralabtest.schemas.vertextest.J.EC, (de.uni_koblenz.jgralabtest.schemas.vertextest.C2) vertex, (de.uni_koblenz.jgralabtest.schemas.vertextest.D2) this);
		}
		@Override
		public java.util.List<? extends de.uni_koblenz.jgralabtest.schemas.vertextest.C2> remove_sourceJ() {
			java.util.List<de.uni_koblenz.jgralabtest.schemas.vertextest.C2> adjacences = new java.util.ArrayList<de.uni_koblenz.jgralabtest.schemas.vertextest.C2>();
			de.uni_koblenz.jgralabtest.schemas.vertextest.J edge = (de.uni_koblenz.jgralabtest.schemas.vertextest.J) getFirstIncidence(de.uni_koblenz.jgralabtest.schemas.vertextest.J.class, EdgeDirection.IN);
			while (edge != null) {
				de.uni_koblenz.jgralabtest.schemas.vertextest.J next = (de.uni_koblenz.jgralabtest.schemas.vertextest.J) edge.getNextIncidence(de.uni_koblenz.jgralabtest.schemas.vertextest.J.class, EdgeDirection.IN);
				adjacences.add((de.uni_koblenz.jgralabtest.schemas.vertextest.C2) edge.getThat());
				edge.delete();
				edge = next;
			}
			return adjacences;
		...
		public Iterable<? extends de.uni_koblenz.jgralabtest.schemas.vertextest.C2> get_sourceJ() {
			return new de.uni_koblenz.jgralab.impl.NeighbourIterable<de.uni_koblenz.jgralabtest.schemas.vertextest.J, de.uni_koblenz.jgralabtest.schemas.vertextest.C2>(this, de.uni_koblenz.jgralabtest.schemas.vertextest.J.class, EdgeDirection.IN);
		}
		@Override
		public de.uni_koblenz.jgralabtest.schemas.vertextest.J add_sourceE(de.uni_koblenz.jgralabtest.schemas.vertextest.A vertex) {
			if (!(vertex instanceof de.uni_koblenz.jgralabtest.schemas.vertextest.C2)) {
				throw new de.uni_koblenz.jgralab.GraphException("The rolename sourceE was redefined at the vertex class de.uni_koblenz.jgralabtest.schemas.vertextest.D2. Only vertices of de.uni_koblenz.jgralabtest.schemas.vertextest.C2 are allowed."); 
			}
			return ((de.uni_koblenz.jgralabtest.schemas.vertextest.VertexTestGraph)getGraph()).createEdge(de.uni_koblenz.jgralabtest.schemas.vertextest.J.EC, (de.uni_koblenz.jgralabtest.schemas.vertextest.C2) vertex, (de.uni_koblenz.jgralabtest.schemas.vertextest.D2) this);
		}
		@Override
		...
		public Iterable<? extends de.uni_koblenz.jgralabtest.schemas.vertextest.C2> get_sourceE() {
			return new de.uni_koblenz.jgralab.impl.NeighbourIterable<de.uni_koblenz.jgralabtest.schemas.vertextest.E, de.uni_koblenz.jgralabtest.schemas.vertextest.C2>(this, de.uni_koblenz.jgralabtest.schemas.vertextest.E.class, EdgeDirection.IN);
		}
		@Override
		public de.uni_koblenz.jgralabtest.schemas.vertextest.G add_sourceG(de.uni_koblenz.jgralabtest.schemas.vertextest.C vertex) {
			return ((de.uni_koblenz.jgralabtest.schemas.vertextest.VertexTestGraph)getGraph()).createEdge(de.uni_koblenz.jgralabtest.schemas.vertextest.G.EC, (de.uni_koblenz.jgralabtest.schemas.vertextest.C) vertex, (de.uni_koblenz.jgralabtest.schemas.vertextest.D2) this);
		}
		@Override
