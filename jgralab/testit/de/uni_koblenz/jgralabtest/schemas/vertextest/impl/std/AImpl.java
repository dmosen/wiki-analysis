...
public class AImpl extends VertexImpl implements de.uni_koblenz.jgralabtest.schemas.vertextest.A, de.uni_koblenz.jgralab.Vertex {

	public AImpl(int id, de.uni_koblenz.jgralab.Graph g) {
		super(id, g);
	}

	@Override
	public final de.uni_koblenz.jgralab.schema.VertexClass getAttributedElementClass() {
		return de.uni_koblenz.jgralabtest.schemas.vertextest.A.VC;
	}

	@Override
	public final java.lang.Class<? extends de.uni_koblenz.jgralab.Vertex> getSchemaClass() {
		return de.uni_koblenz.jgralabtest.schemas.vertextest.A.class;
	}

	public <T> T getAttribute(String attributeName) {
		throw new NoSuchAttributeException("A doesn't contain an attribute " + attributeName);
	}
	...
	public de.uni_koblenz.jgralabtest.schemas.vertextest.I getFirstIIncidence(EdgeDirection orientation) {
		...
		public de.uni_koblenz.jgralabtest.schemas.vertextest.I add_sourceI(de.uni_koblenz.jgralabtest.schemas.vertextest.A vertex) {
			return ((de.uni_koblenz.jgralabtest.schemas.vertextest.VertexTestGraph)getGraph()).createEdge(de.uni_koblenz.jgralabtest.schemas.vertextest.I.EC, (de.uni_koblenz.jgralabtest.schemas.vertextest.A) vertex, (de.uni_koblenz.jgralabtest.schemas.vertextest.A) this);
		}
		@Override
		...
		public de.uni_koblenz.jgralabtest.schemas.vertextest.H add_w(de.uni_koblenz.jgralabtest.schemas.vertextest.B vertex) {
			return ((de.uni_koblenz.jgralabtest.schemas.vertextest.VertexTestGraph)getGraph()).createEdge(de.uni_koblenz.jgralabtest.schemas.vertextest.H.EC, (de.uni_koblenz.jgralabtest.schemas.vertextest.A) this, (de.uni_koblenz.jgralabtest.schemas.vertextest.B) vertex);
		}
		@Override
		...
		public de.uni_koblenz.jgralabtest.schemas.vertextest.I add_v(de.uni_koblenz.jgralabtest.schemas.vertextest.A vertex) {
			return ((de.uni_koblenz.jgralabtest.schemas.vertextest.VertexTestGraph)getGraph()).createEdge(de.uni_koblenz.jgralabtest.schemas.vertextest.I.EC, (de.uni_koblenz.jgralabtest.schemas.vertextest.A) this, (de.uni_koblenz.jgralabtest.schemas.vertextest.A) vertex);
		}
		@Override
		...
		public de.uni_koblenz.jgralabtest.schemas.vertextest.K add_targetK(de.uni_koblenz.jgralabtest.schemas.vertextest.B vertex) {
			return ((de.uni_koblenz.jgralabtest.schemas.vertextest.VertexTestGraph)getGraph()).createEdge(de.uni_koblenz.jgralabtest.schemas.vertextest.K.EC, (de.uni_koblenz.jgralabtest.schemas.vertextest.A) this, (de.uni_koblenz.jgralabtest.schemas.vertextest.B) vertex);
		}
		@Override
		...
		public de.uni_koblenz.jgralabtest.schemas.vertextest.E add_x(de.uni_koblenz.jgralabtest.schemas.vertextest.B vertex) {
			return ((de.uni_koblenz.jgralabtest.schemas.vertextest.VertexTestGraph)getGraph()).createEdge(de.uni_koblenz.jgralabtest.schemas.vertextest.E.EC, (de.uni_koblenz.jgralabtest.schemas.vertextest.A) this, (de.uni_koblenz.jgralabtest.schemas.vertextest.B) vertex);
		}
		@Override
		public java.util.List<? extends de.uni_koblenz.jgralabtest.schemas.vertextest.B> remove_x() {
			java.util.List<de.uni_koblenz.jgralabtest.schemas.vertextest.B> adjacences = new java.util.ArrayList<de.uni_koblenz.jgralabtest.schemas.vertextest.B>();
			de.uni_koblenz.jgralabtest.schemas.vertextest.E edge = (de.uni_koblenz.jgralabtest.schemas.vertextest.E) getFirstIncidence(de.uni_koblenz.jgralabtest.schemas.vertextest.E.class, EdgeDirection.OUT);
			while (edge != null) {
				de.uni_koblenz.jgralabtest.schemas.vertextest.E next = (de.uni_koblenz.jgralabtest.schemas.vertextest.E) edge.getNextIncidence(de.uni_koblenz.jgralabtest.schemas.vertextest.E.class, EdgeDirection.OUT);
				adjacences.add((de.uni_koblenz.jgralabtest.schemas.vertextest.B) edge.getThat());
				edge.delete();
				edge = next;
			}
		...
		public Iterable<? extends de.uni_koblenz.jgralabtest.schemas.vertextest.B> get_x() {
			return new de.uni_koblenz.jgralab.impl.NeighbourIterable<de.uni_koblenz.jgralabtest.schemas.vertextest.E, de.uni_koblenz.jgralabtest.schemas.vertextest.B>(this, de.uni_koblenz.jgralabtest.schemas.vertextest.E.class, EdgeDirection.OUT);
		}
