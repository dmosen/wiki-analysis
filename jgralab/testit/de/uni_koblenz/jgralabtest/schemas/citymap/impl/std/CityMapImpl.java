...
public class CityMapImpl extends GraphImpl implements de.uni_koblenz.jgralabtest.schemas.citymap.CityMap, de.uni_koblenz.jgralab.Graph {
	...
	**/
	 ...
	 * For instantiating a Graph, use the Schema and a GraphFactory
	**/
	public CityMapImpl(int vMax, int eMax) {
		this(null, vMax, eMax);
	}
	 ...
	 * For instantiating a Graph, use the Schema and a GraphFactory
	**/
	public CityMapImpl(java.lang.String id, int vMax, int eMax) {
		super(id, de.uni_koblenz.jgralabtest.schemas.citymap.CityMap.GC, vMax, eMax);
	 ...
	 * For instantiating a Graph, use the Schema and a GraphFactory
	**/
	public CityMapImpl(java.lang.String id) {
		super(id, de.uni_koblenz.jgralabtest.schemas.citymap.CityMap.GC);
		initializeAttributesWithDefaultValues();
	}
