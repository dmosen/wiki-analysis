...
public interface Intersection extends de.uni_koblenz.jgralabtest.schemas.citymap.Junction {

	public static final de.uni_koblenz.jgralab.schema.VertexClass VC = de.uni_koblenz.jgralabtest.schemas.citymap.CityMapSchema.instance().vc_Intersection;
	...
	/**
	 * @return the next de.uni_koblenz.jgralabtest.schemas.citymap.Intersection vertex in the global vertex sequence
	 */
