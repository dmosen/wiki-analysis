...
public class CommentTestGraphImpl extends GraphImpl implements de.uni_koblenz.jgralabtest.schemas.commenttest.CommentTestGraph, de.uni_koblenz.jgralab.Graph {
	...
	**/
	public CommentTestGraphImpl(java.lang.String id, GraphDatabase graphDatabase) {
		super(id, de.uni_koblenz.jgralabtest.schemas.commenttest.CommentTestGraph.GC, graphDatabase);
	 ...
	 * For instantiating a Graph, use a GraphFactory
	**/
	public CommentTestGraphImpl(java.lang.String id, int vMax, int eMax, GraphDatabase graphDatabase) {
		super(id, vMax, eMax, de.uni_koblenz.jgralabtest.schemas.commenttest.CommentTestGraph.GC, graphDatabase);
		initializeAttributesWithDefaultValues();
	}
