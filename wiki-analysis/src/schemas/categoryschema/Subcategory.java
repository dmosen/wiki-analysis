...
public interface Subcategory extends de.uni_koblenz.jgralab.Edge {
	...
	public static final de.uni_koblenz.jgralab.schema.EdgeClass EC = schemas.categoryschema.CategorySchema
			.instance().ec_Subcategory;
	...
	/**
	 * @return the next schemas.categoryschema.Subcategory edge in the global
	 *         edge sequence
	 */
	public schemas.categoryschema.Subcategory getNextSubcategoryInGraph();

	/**
	 * @return the next edge of class schemas.categoryschema.Subcategory at the
	 *         "this" vertex
	 */
